...
(() => {
  ...
  const MAP = [
    ...
    ['header .hero-cta .btn-copper', { nl: 'Bezoek copperant.com ↗', pl: 'Odwiedź copperant.com ↗', ro: 'Vizitează copperant.com ↗', de: 'copperant.com besuchen ↗', fr: 'Visiter copperant.com ↗', es: 'Visitar copperant.com ↗', it: 'Visita copperant.com ↗' }],
    ['header .hero-cta .btn-ghost', { nl: 'Bekijk het assortiment', pl: 'Zobacz asortyment', ro: 'Explorează gama', de: 'Das Sortiment ansehen', fr: 'Voir la gamme', es: 'Ver la gama', it: 'Scopri la gamma' }],
    ...
    ['#mission .eyebrow', { nl: 'Waarom Copperant', pl: 'Dlaczego Copperant', ro: 'De ce Copperant', de: 'Warum Copperant', fr: 'Pourquoi Copperant', es: 'Por qué Copperant', it: 'Perché Copperant' }],
    ['.mission-quote', {
    ...
    ['#range .eyebrow', { nl: 'Het assortiment', pl: 'Asortyment', ro: 'Gama', de: 'Das Sortiment', fr: 'La gamme', es: 'La gama', it: 'La gamma' }],
    ['#range h2', {
    ...
    ['#green .eyebrow', { nl: 'Duurzaamheid', pl: 'Zrównoważoność', ro: 'Sustenabilitate', de: 'Nachhaltigkeit', fr: 'Durabilité', es: 'Sostenibilidad', it: 'Sostenibilità' }],
    ['#green h2', {
    ...
    ['#green .stat .n', { nl: ['CO₂-neutraal','Plantaardig','Onbeperkt'], pl: ['Neutralna CO₂','Roślinna','Bez limitu'], ro: ['Neutră CO₂','Vegetală','Nelimitat'], de: ['CO₂-neutral','Pflanzlich','Unbegrenzt'], fr: ['Neutre en CO₂','Végétale','Illimité'], es: ['Neutra en CO₂','Vegetal','Ilimitado'], it: ['Neutra in CO₂','Vegetale','Illimitato'] }],
    ['#green .stat .l', {
    ...
    ['#pros .eyebrow', { nl: 'Voor professionals', pl: 'Dla profesjonalistów', ro: 'Pentru profesioniști', de: 'Für Profis', fr: 'Pour les pros', es: 'Para profesionales', it: 'Per i professionisti' }],
    ['#pros h2', {
    ...
    ['.cta-card h2', { nl: 'Bekijk het volledige Copperant-systeem', pl: 'Zobacz pełny system Copperant', ro: 'Vezi întregul sistem Copperant', de: 'Das komplette Copperant-System ansehen', fr: 'Découvrir tout le système Copperant', es: 'Descubre todo el sistema Copperant', it: 'Scopri l\'intero sistema Copperant' }],
    ['.cta-card p', {
    ...
    ['.cta-card .btn-copper', { nl: 'Naar copperant.com ↗', pl: 'Przejdź do copperant.com ↗', ro: 'Mergi la copperant.com ↗', de: 'Zu copperant.com ↗', fr: 'Aller sur copperant.com ↗', es: 'Ir a copperant.com ↗', it: 'Vai su copperant.com ↗' }],
