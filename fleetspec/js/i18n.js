...
(() => {
  ...
  const MAP = [
    ...
    ['#performance .lead', {
      ...
      tr: 'Korozyon direncini, kolay uygulamayı ve uzun ömürlü dayanıklılığı taşımacılık pazarlarında birleştiren premium kaplamalar.', no: 'Premium-belegg som kombinerer korrosjonsbestandighet, enkel påføring og slitestyrke på lang sikt på tvers av transportmarkedene.', sv: 'Premiumbeläggningar som kombinerar korrosionsbeständighet, enkel applicering och hållbarhet på lång sikt över transportmarknaderna.' }],
