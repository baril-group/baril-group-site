...
(() => {
  ...
  const MAP = [
    ...
    ['header .eyebrow .eb-txt', {
      ...
      tr: 'FleetSpec — Filo &amp; nakliye boya yenileme · Bir Baril Group markası' }],
    ['header h1', {
      ...
      tr: 'Filoyu<br><span class="acc">hareket halinde tutun</span>' }],
    ['.hero-sub', {
      ...
      tr: 'Ticari taşımacılık için tamamen entegre bir boya yenileme sistemi — astarlar, üretan son kat boyalar ve üstün korozyon direnci ile hassas renk eşleşmeleri için tasarlanmış bir <strong>intermix renk programı</strong>.' }],
    ...
    ['.hero-foot span:first-child', {
      ...
      tr: 'Astarlar · Son katlar · Intermix renk · Korozyon' }],
    ['.scroll-hint', { nl: 'Scroll', pl: 'Przewiń', ro: 'Derulează', de: 'Scrollen', fr: 'Défiler', es: 'Desliza', it: 'Scorri', tr: 'Kaydır' }],

    ['#mission .eyebrow', { nl: 'Waarom FleetSpec', pl: 'Dlaczego FleetSpec', ro: 'De ce FleetSpec', de: 'Warum FleetSpec', fr: 'Pourquoi FleetSpec', es: 'Por qué FleetSpec', it: 'Perché FleetSpec', tr: 'Neden FleetSpec' }],
    ['.mission-quote', {
      ...
      tr: 'Duruş süresi paraya mal olur. FleetSpec eksiksiz, <em>entegre</em> bir boya yenileme sistemi sunar — astarlar, son katlar ve bir intermix renk programı — dayanıklı koruma ve her araçta hızlı, doğru renk için tasarlandı.' }],
    ['#mission .mm b', {
      ...
      tr: ['Tek entegre sistem','Renk, tam isabet','Yol için yapıldı'] }],
    ['#mission .mm span', {
    ...
    ['#products h2', {
      ...
      tr: 'Astardan <span class="acc">son kata</span>' }],
    ['#products .lead', {
      ...
      tr: 'FleetSpec serisi tüm boya yenilemeyi kapsar — korozyonla mücadele eden astarlar ve yüksek parlaklıkta üretan son kat boyalar, hassas bir intermix renk sistemiyle desteklenir.' }],
    ['#products .feat .prod-tag', {
      ...
      tr: ['Astar · 2K','Son kat · Yüksek parlaklık','Baz · 1K','Renk'] }],
    ...
    ['#performance h2', {
      ...
      tr: '<span class="acc">Yol</span> için tasarlandı' }],
    ['#performance .lead', {
      nl: 'Premium coatings die corrosiebestendigheid, eenvoudige applicatie en duurzaamheid op lange termijn combineren over de transportmarkten heen.',
      pl: 'Powłoki premium łączące odporność na korozję, łatwą aplikację i trwałość na lata w różnych segmentach transportu.',
      ro: 'Vopsele premium care combină rezistența la coroziune, aplicarea ușoară și durabilitatea pe termen lung în piețele de transport.',
      de: 'Premium-Beschichtungen, die Korrosionsbeständigkeit, einfache Applikation und langfristige Haltbarkeit über die Transportmärkte hinweg vereinen.',
      fr: 'Des revêtements premium qui allient résistance à la corrosion, facilité d\'application et durabilité à long terme sur les marchés du transport.',
      es: 'Recubrimientos premium que combinan resistencia a la corrosión, fácil aplicación y durabilidad a largo plazo en los mercados del transporte.',
      it: 'Rivestimenti premium che uniscono resistenza alla corrosione, facilità di applicazione e durabilità a lungo termine nei mercati del trasporto.',
      tr: 'Korozyon direncini, kolay uygulamayı ve uzun ömürlü dayanıklılığı taşımacılık pazarlarında birleştiren premium kaplamalar.' }],
    ['#performance .pills span', {
      ...
      tr: ['Korozyon direnci','Yüksek parlaklık','Intermix renk','Kolay uygulama'] }],
    ['#performance .feat b', {
      ...
      tr: ['Korozyon direnci','Uzun ömürlü dayanıklılık','Hassas renk eşleştirme','Kolay uygulama','Yüksek parlaklıkta bitiş','Taşımacılığa hazır'] }],
    ...
    ['#apply h2', {
      ...
      tr: '<span class="acc">Hareket halindeki filolar</span><br>için kaplamalar' }],
    ['#apply .lead', {
      ...
      tr: 'Araçların ekmeğini kazandığı her yerde FleetSpec onları korur ve pırıl pırıl tutar.' }],
    ['#apply .sheet-row b', {
      ...
      tr: ['Kamyon &amp; römork','Ticari taşımacılık','Denizcilik','Havacılık','Endüstriyel ekipman','Boyahaneler &amp; boya yenileyiciler'] }],
    ...
    ['#contact h2', {
      ...
      tr: 'Filonuzun kaplamasını belirleyin' }],
    ['#contact p', {
      ...
      tr: 'FleetSpec sistemi, renk programı ve filonuza ve atölyenize uygun son kat boyalar hakkında boya yenileme uzmanlarımıza danışın.' }],
    ...
    ['.foot-claim', {
      ...
      tr: 'Filo &amp; nakliye için premium boya yenileme kaplamaları.' }],
