...
(() => {
  ...
  const MAP = [
    ...
    ['#about .mm span', {
      ...
      es: [
        'La protección anticorrosión en capa fina prolonga la vida del acero, la infraestructura y las instalaciones — hasta las clases ISO 12944 más altas.',
        'Más cobertura por litro con un menor espesor de película — menos ciclos de mantenimiento, una huella menor por m² protegido.',
        'Materias primas biobasadas y circulares sustituyen a la química fósil, paso a paso — de &lt;10% en 2022 a 100% en 2030.',
        'ISO 9001, 14001 y 45001. Homologaciones de producto hasta NORSOK M-501 para offshore — probadas en los entornos más exigentes.'],
      it: [
    ...
    ['.sheet-row span', {
      ...
      es: [
        "1987 · 's-Hertogenbosch, Países Bajos <em>— parte de Baril Group</em>",
        'Países Bajos · Estados Unidos · Polonia',
        'Utilizado en más de 20 países a través de distribuidores locales',
        'Acero e infraestructura · Industria OEM y metal · Marina y offshore · Empresas de pintura',
        'Biobased · DualCure · SteelKote · Aquaran · Bariline · FleetSpec (EE. UU.)',
        'Clases de corrosividad ISO 12944 · NORSOK M-501 <em>offshore</em>',
        ...
        'Asesoramiento técnico · ayuda con la especificación · formación de aplicadores vía Baril Academy · información de seguridad siempre actualizada',
        'Baril Group <em>— con Copperant y Fairf</em>'],
      it: [
        "1987 · 's-Hertogenbosch, Paesi Bassi <em>— parte di Baril Group</em>",
        'Paesi Bassi · Stati Uniti · Polonia',
        'Utilizzato in oltre 20 Paesi tramite distributori locali',
        'Acciaio e infrastrutture · Industria OEM e metallo · Marina e offshore · Imprese di verniciatura',
        'Biobased · DualCure · SteelKote · Aquaran · Bariline · FleetSpec (USA)',
        'Classi di corrosività ISO 12944 · NORSOK M-501 <em>offshore</em>',
