...
(() => {
  ...
  const MAP = [
    ...
    ['header .eyebrow .eb-txt', {
      ...
      tr: "Baril Coatings — Endüstriyel ve koruyucu kaplamalar · 1982'den beri" }],
    ['header h1', {
    ...
    ['.sheet-row b', {"nl":["Opgericht","Productie","Markten","Assortiment","Normen","Ondersteuning","Onderdeel van"],"pl":["Założona","Produkcja","Rynki","Gamy","Normy","Wsparcie","Część"],"ro":["Înființată","Producție","Piețe","Game","Standarde","Suport","Parte din"],"de":["Gegründet","Produktion","Märkte","Sortiment","Normen","Unterstützung","Teil von"],"fr":["Fondée","Production","Marchés","Gammes","Normes","Support","Fait partie de"],"es":["Fundada","Producción","Mercados","Gamas","Normas","Soporte","Parte de"],"it":["Fondata","Produzione","Mercati","Gamme","Norme","Supporto","Parte di"],"tr":["Kuruluş","Üretim","Pazarlar","Ürün yelpazesi","Standartlar","Destek","Bir parçası"]}],
    ['.sheet-row span', {"nl":["1982 · 's-Hertogenbosch, Nederland <em>— onderdeel van Baril Group</em>","Nederland · Verenigde Staten · Polen","Staal & infrastructuur · OEM & metaalindustrie · Marine & offshore · Schildersbedrijven","Biobased · DualCure · SteelKote · Aquaran · Bariline","ISO 12944-corrosieklassen · NORSOK M-501 <em>offshore</em>","Technisch advies · specificatiehulp · applicateurstraining via Baril Academy · altijd actuele veiligheidsinformatie","Baril Group"],"pl":["1982 · 's-Hertogenbosch, Holandia <em>— część Baril Group</em>","Holandia · Stany Zjednoczone · Polska","Stal i infrastruktura · Przemysł OEM i metalowy · Morskie i offshore · Firmy malarskie","Biobased · DualCure · SteelKote · Aquaran · Bariline","Klasy korozyjności ISO 12944 · NORSOK M-501 <em>offshore</em>","Doradztwo techniczne · pomoc w specyfikacji · szkolenia wykonawców Baril Academy · zawsze aktualne dane bezpieczeństwa","Baril Group"],"ro":["1982 · 's-Hertogenbosch, Țările de Jos <em>— parte din Baril Group</em>","Țările de Jos · Statele Unite · Polonia","Oțel și infrastructură · Industrie OEM și metalică · Maritim și offshore · Firme de vopsire","Biobased · DualCure · SteelKote · Aquaran · Bariline","Clase de corozivitate ISO 12944 · NORSOK M-501 <em>offshore</em>","Consultanță tehnică · ajutor la specificații · instruire aplicatori Baril Academy · date de siguranță mereu actuale","Baril Group"],"de":["1982 · 's-Hertogenbosch, Niederlande <em>— Teil der Baril Group</em>","Niederlande · Vereinigte Staaten · Polen","Stahl & Infrastruktur · OEM & Metallindustrie · Marine & Offshore · Malerbetriebe","Biobased · DualCure · SteelKote · Aquaran · Bariline","ISO-12944-Korrosionsklassen · NORSOK M-501 <em>Offshore</em>","Technische Beratung · Spezifikationshilfe · Applikatorschulung über die Baril Academy · stets aktuelle Sicherheitsinformationen","Baril Group"],"fr":["1982 · 's-Hertogenbosch, Pays-Bas <em>— fait partie du groupe Baril</em>","Pays-Bas · États-Unis · Pologne","Acier et infrastructure · Industrie OEM et métal · Marine et offshore · Entreprises de peinture","Biobased · DualCure · SteelKote · Aquaran · Bariline","Classes de corrosivité ISO 12944 · NORSOK M-501 <em>offshore</em>","Conseil technique · aide à la spécification · formation des applicateurs via la Baril Academy · informations de sécurité toujours à jour","Baril Group"],"es":["1982 · 's-Hertogenbosch, Países Bajos <em>— parte de Baril Group</em>","Países Bajos · Estados Unidos · Polonia","Acero e infraestructura · Industria OEM y metal · Marina y offshore · Empresas de pintura","Biobased · DualCure · SteelKote · Aquaran · Bariline","Clases de corrosividad ISO 12944 · NORSOK M-501 <em>offshore</em>","Asesoramiento técnico · ayuda con la especificación · formación de aplicadores vía Baril Academy · información de seguridad siempre actualizada","Baril Group"],"it":["1982 · 's-Hertogenbosch, Paesi Bassi <em>— parte di Baril Group</em>","Paesi Bassi · Stati Uniti · Polonia","Acciaio e infrastrutture · Industria OEM e metallo · Marina e offshore · Imprese di verniciatura","Biobased · DualCure · SteelKote · Aquaran · Bariline","Classi di corrosività ISO 12944 · NORSOK M-501 <em>offshore</em>","Consulenza tecnica · supporto alla specifica · formazione applicatori tramite Baril Academy · informazioni di sicurezza sempre aggiornate","Baril Group"],"tr":["1982 · 's-Hertogenbosch, Hollanda <em>— Baril Group'un bir parçası</em>","Hollanda · ABD · Polonya","Çelik ve altyapı · OEM ve metal endüstrisi · Denizcilik ve açık deniz · Boya firmaları","Biobased · DualCure · SteelKote · Aquaran · Bariline","ISO 12944 korozyon sınıfları · NORSOK M-501 <em>açık deniz</em>","Teknik danışmanlık · şartname desteği · Baril Academy aracılığıyla uygulayıcı eğitimi · her zaman güncel güvenlik bilgileri","Baril Group"]}],
