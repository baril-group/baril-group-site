...
(() => {
  ...
  const MAP = [
    ...
    ['header .eyebrow', {
      ...
      tr: 'Resinwerks — Reçineli zemin kaplamaları · Bir Baril Group markası' }],
    ['header h1', {
      ...
      tr: 'Performans gösteren<br><span class="acc">zeminler</span>' }],
    ['.hero-sub', {
      ...
      tr: 'Epoksi, poliaspartik ve üretan zemin sistemleri — <strong>%100 katı madde, 0-VOC</strong> ve garajlar, showroom\'lar ve en zorlu endüstriyel zeminler için üretildi.' }],
    ...
    ['.hero-foot span:first-child', {
      ...
      tr: 'Epoksi · Poliaspartik · Üretan · Metalik' }],
    ['.scroll-hint', { nl: 'Scroll', pl: 'Przewiń', ro: 'Derulează', de: 'Scrollen', fr: 'Défiler', es: 'Desliza', it: 'Scorri', tr: 'Kaydır' }],

    ['#mission .eyebrow', { nl: 'Waarom Resinwerks', pl: 'Dlaczego Resinwerks', ro: 'De ce Resinwerks', de: 'Warum Resinwerks', fr: 'Pourquoi Resinwerks', es: 'Por qué Resinwerks', it: 'Perché Resinwerks', tr: 'Neden Resinwerks' }],
    ['.mission-quote', {
      ...
      tr: 'Bir zemin üzerine gelen her şeye dayanır. Resinwerks; sıkıca yapışan, kimyasallara dayanan ve yıllarca harika görünen <em>reçineli</em> kaplama sistemleri — epoksi, poliaspartik ve üretan — tasarlar.' }],
    ['#mission .mm b', {
      ...
      tr: ['Tam reçineli sistemler','%100 katı madde, 0-VOC','Garajdan fabrikaya'] }],
    ['#mission .mm span', {
      nl: ['Primers, basislagen, instrooimedia en toplagen — elke laag van de vloer, ontworpen om samen te werken.','Hoogvaste en watergedragen chemie met nul VOC; sommige gebouwd op plantaardige harsen in plaats van aardolie.','Systemen voor garages bij woningen, showrooms, commerciële ruimtes en veeleisende industriële vloeren.'],
      pl: ['Grunty, warstwy bazowe, posypki i warstwy nawierzchniowe — każda warstwa posadzki, zaprojektowana do wspólnej pracy.','Wysokocząsteczkowe i wodorozcieńczalne chemie o zerowym VOC; niektóre oparte na żywicach roślinnych zamiast ropy naftowej.','Systemy do garaży przydomowych, salonów, przestrzeni komercyjnych i wymagających posadzek przemysłowych.'],
      ro: ['Amorse, straturi de bază, materiale presărate și straturi finale — fiecare strat al pardoselii, proiectat să lucreze împreună.','Chimii cu conținut ridicat de substanță uscată și pe bază de apă, cu zero VOC; unele bazate pe rășini vegetale în loc de petrol.','Sisteme pentru garaje rezidențiale, showroom-uri, spații comerciale și pardoseli industriale exigente.'],
      de: ['Grundierungen, Basisschichten, Einstreumedien und Deckschichten — jede Schicht des Bodens, aufeinander abgestimmt.','Hochfeste und wasserbasierte Chemien mit null VOC; einige auf Basis pflanzlicher Harze statt Erdöl.','Systeme für Garagen am Haus, Showrooms, Gewerberäume und anspruchsvolle Industrieböden.'],
      fr: ['Primaires, couches de base, médias de saupoudrage et couches de finition — chaque couche du sol, conçue pour fonctionner ensemble.','Chimies à fort extrait sec et à base d\'eau sans aucun COV ; certaines reposant sur des résines végétales plutôt que sur le pétrole.','Des systèmes pour les garages résidentiels, les showrooms, les espaces commerciaux et les sols industriels exigeants.'],
      es: ['Imprimaciones, capas base, áridos de espolvoreo y capas de acabado — cada capa del suelo, diseñada para trabajar en conjunto.','Químicas de alto contenido en sólidos y al agua con cero VOC; algunas basadas en resinas vegetales en lugar de petróleo.','Sistemas para garajes residenciales, salas de exposición, espacios comerciales y suelos industriales exigentes.'],
      it: ['Primer, strati di base, granuli a spaglio e strati di finitura — ogni strato del pavimento, progettato per lavorare insieme.','Chimiche ad alto solido e a base acqua con zero VOC; alcune basate su resine vegetali anziché sul petrolio.','Sistemi per garage residenziali, showroom, spazi commerciali e pavimenti industriali esigenti.'],
      tr: ['Astarlar, taban katları, serpme malzemeler ve son katlar — zeminin her katmanı, birlikte çalışmak üzere tasarlandı.','Sıfır VOC içeren yüksek katı maddeli ve su bazlı kimyalar; bazıları petrol yerine bitki bazlı reçinelerle üretilir.','Konut garajları, showroom\'lar, ticari alanlar ve zorlu endüstriyel zeminler için sistemler.'] }],
    ...
    ['#products h2', {
      ...
      tr: 'Her katman, <span class="acc">tek sistem</span>' }],
    ['#products .lead', {
      ...
      tr: 'Resinwerks, zemine göre ayarlanmış %100 katı madde ve su bazlı reçineli kaplamalardan oluşan eksiksiz bir ürün hattı sunar — astarlar, dolgu katları ve son katlar.' }],
    ['#products .feat .prod-tag', {
      ...
      tr: ['Poliaspartik','Epoksi','Üretan','Dekoratif'] }],
    ...
    ['#performance h2', {
      ...
      tr: '<span class="acc">Yükü taşımak</span> için yapıldı' }],
    ['#performance .lead', {
    ...
    ['#performance .pills span', {
      ...
      tr: ['%100 katı madde / su bazlı','0-VOC','Bitki bazlı reçineler','Metalik &amp; flake'] }],
    ['#performance .feat b', {
    ...
    ['#apply h2', {
      ...
      tr: '<span class="acc">Her alan</span><br>için zeminler' }],
    ['#apply .lead', {
      ...
      tr: 'Betonun hem iyi görünmesi hem de çok çalışması gereken her yerde, Resinwerks\'in uygun bir reçineli sistemi vardır.' }],
    ['#apply .sheet-row b', {
    ...
    ['#contact p', {
      ...
      tr: 'Tek bir garajdan koca bir fabrikaya kadar — betonunuz için doğru Resinwerks sistemi hakkında zemin kaplama uzmanlarımıza danışın.' }],
    ...
    ['.foot-claim', {
      ...
      tr: 'Yüksek performanslı reçineli zemin kaplamaları.' }],
    ['footer .foot-grid div:nth-child(2) a', {
      ...
      tr: ['Poliaspartik','Epoksi','Üretan','Metalik &amp; flake'] }],
    ['footer h5', {
