...
(() => {
  ...
  const MAP = [
    ...
    ['header .hero-cta .btn-solid', { nl: 'Bekijk het systeem', pl: 'Poznaj system', ro: 'Explorează sistemul', de: 'Das System ansehen', fr: 'Découvrir le système', es: 'Ver el sistema', it: 'Scopri il sistema' }],
    ...
    ['#mission .eyebrow', { nl: 'Waarom TintLab', pl: 'Dlaczego TintLab', ro: 'De ce TintLab', de: 'Warum TintLab', fr: 'Pourquoi TintLab', es: 'Por qué TintLab', it: 'Perché TintLab' }],
    ['.mission-quote', {
    ...
    ['#system .eyebrow', { nl: 'RedLike™-inkleursysteem', pl: 'System barwiący RedLike™', ro: 'Sistemul de nuanțare RedLike™', de: 'RedLike™-Abtönsystem', fr: 'Système de teinte RedLike™', es: 'Sistema de tintado RedLike™', it: 'Sistema di tintometria RedLike™' }],
    ['#system h2', {
    ...
    ['#system .badge', { nl: 'Handmatig &amp; automatisch mengen', pl: 'Mieszanie ręczne i automatyczne', ro: 'Amestecare manuală și automată', de: 'Manuelles &amp; automatisches Mischen', fr: 'Mélange manuel et automatique', es: 'Mezcla manual y automática', it: 'Miscelazione manuale e automatica' }],
    ...
    ['#colors .eyebrow', { nl: "Kleurpasta's", pl: 'Pasty barwiące', ro: 'Coloranți', de: 'Farbpasten', fr: 'Pâtes colorantes', es: 'Pastas de color', it: 'Paste coloranti' }],
    ['#colors h2', {
    ...
    ['.cta-card .eyebrow', { nl: 'Aan de slag', pl: 'Zacznij', ro: 'Începe', de: 'Loslegen', fr: 'Commencer', es: 'Empezar', it: 'Inizia' }],
    ['.cta-card h2', { nl: 'Breng TintLab naar je lijn', pl: 'Wprowadź TintLab na swoją linię', ro: 'Adu TintLab pe linia ta', de: 'Bring TintLab auf deine Linie', fr: 'Amenez TintLab sur votre ligne', es: 'Lleva TintLab a tu línea', it: 'Porta TintLab sulla tua linea' }],
    ['.cta-card p', {
