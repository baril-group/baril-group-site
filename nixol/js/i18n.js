...
(() => {
  ...
  const MAP = [
    ...
    ['.navlinks a', {
      ...
      tr: ['Neden Nixol','Nasıl çalışır','Özellikler','Sürdürülebilirlik','Uygulamalar','İletişim'], no: ['Hvorfor Nixol','Slik virker det','Egenskaper','Bærekraft','Bruksområder','Kontakt'], sv: ['Varför Nixol','Så fungerar det','Egenskaper','Hållbarhet','Användningsområden','Kontakt'] }],
    ['header .eyebrow .eb-txt', {
      ...
      tr: 'Nixol — Geçici sera gölgeleme · Bir Baril Group markası', no: 'Nixol — Midlertidig veksthusskygging · Et merke fra Baril Group', sv: 'Nixol — Tillfällig växthusskuggning · Ett varumärke från Baril Group' }],
    ['header h1', {
      ...
      tr: 'Berrak sonuçlar,<br><span class="sun">sezon</span><br>sezon üstüne', no: 'Klare resultater,<br><span class="sun">sesong</span><br>etter sesong', sv: 'Tydliga resultat,<br><span class="sun">säsong</span><br>efter säsong' }],
    ['.hero-sub', {
      ...
      tr: 'Genç bitkileri yakıcı güneşten koruyan geçici bir gölgeleme kaplaması — cam ve polikarbonat üzerinde <strong>optimal ışık düzenlemesi</strong>, döngüsel tebeşirden üretilmiş, insan ve bitki için güvenli ve tamamen çıkarılabilir.', no: 'Et midlertidig skyggebelegg som beskytter unge vekster mot den sterke sola — <strong>optimal lysregulering</strong> på glass og polykarbonat, laget av sirkulært kritt, trygt for mennesker og planter, og fullt avtakbart.', sv: 'En tillfällig skuggbeläggning som skyddar unga grödor mot den starka solen — <strong>optimal ljusreglering</strong> på glas och polykarbonat, tillverkad av cirkulär krita, säker för människor och växter, och helt avlägsningsbar.' }],
    ['header .hero-cta .btn-solid', { nl: 'Hoe het werkt', pl: 'Jak to działa', ro: 'Cum funcționează', de: 'So funktioniert es', fr: 'Comment ça marche', es: 'Cómo funciona', it: 'Come funziona', tr: 'Nasıl çalışır', no: 'Slik virker det', sv: 'Så fungerar det' }],
    ['header .hero-cta .btn-ghost', { nl: 'Vraag een gratis monster aan', pl: 'Poproś o darmową próbkę', ro: 'Cere o mostră gratuită', de: 'Kostenloses Muster anfordern', fr: 'Demander un échantillon gratuit', es: 'Pide una muestra gratuita', it: 'Richiedi un campione gratuito', tr: 'Ücretsiz numune talep edin', no: 'Be om en gratis prøve', sv: 'Beställ ett gratisprov' }],
    ['.hero-foot span:first-child', {
      ...
      tr: 'Cam ve polikarbonat · Yeni yapı ve bakım · Tamamen çıkarılabilir', no: 'Glass &amp; polykarbonat · Nybygg &amp; vedlikehold · Fullt avtakbart', sv: 'Glas &amp; polykarbonat · Nybygge &amp; underhåll · Helt avlägsningsbar' }],
    ['.scroll-hint', { nl: 'Scroll', pl: 'Przewiń', ro: 'Derulează', de: 'Scrollen', fr: 'Défiler', es: 'Desliza', it: 'Scorri', tr: 'Kaydır', no: 'Bla', sv: 'Skrolla' }],

    ['#mission .eyebrow', { nl: 'Waarom Nixol', pl: 'Dlaczego Nixol', ro: 'De ce Nixol', de: 'Warum Nixol', fr: 'Pourquoi Nixol', es: 'Por qué Nixol', it: 'Perché Nixol', tr: 'Neden Nixol', no: 'Hvorfor Nixol', sv: 'Varför Nixol' }],
    ['.mission-quote', {
      ...
      tr: 'Genç bitkilerin ışığa ihtiyacı vardır — ama fazlasına değil. Nixol, <em>güneşin sertliğini alan</em>, berrak ve ayarlanabilir bir gölge katmanı oluşturur ve sonra iz bırakmadan kaybolur.', no: 'Unge vekster trenger lys — men ikke for mye. Nixol legger et klart, regulerbart lag med skygge som <em>tar brodden av sola</em>, og forsvinner deretter sporløst.', sv: 'Unga grödor behöver ljus — men inte för mycket. Nixol lägger ett klart, justerbart lager skugga som <em>tar udden av solen</em>, och försvinner sedan spårlöst.' }],
    ['#mission .mm b', {
      ...
      tr: ['Optimal ışık düzenlemesi','Genç bitkilere nazik','Tamamen çıkarılabilir'], no: ['Optimal lysregulering','Skånsom mot unge vekster','Fullt avtakbart'], sv: ['Optimal ljusreglering','Skonsam mot unga grödor','Helt avlägsningsbar'] }],
    ['#mission .mm span', {
      ...
      tr: ['Işık girişi ile koruma arasındaki doğru denge — büyümeye yetecek kadar aydınlık, korumaya yetecek kadar yumuşak.','Yakıcı güneşi ve sıcağı yumuşatır, böylece fideler yanma ya da stres yaşamadan sakince kök salar.','Sezon döndüğünde Nixol tertemiz yıkanıp gider — dökülme yok, kalıntı yok, camda sürpriz yok.'], no: ['Den rette balansen mellom lysinnslipp og beskyttelse — lyst nok til å vokse, mildt nok til å beskytte.','Demper sterk sol og varme slik at frøplanter etablerer seg rolig, uten svidde blader eller stress.','Når sesongen snur, vaskes Nixol rent av — ingen flassing, ingen rester, ingen overraskelser på glasset.'], sv: ['Den rätta balansen mellan ljusinsläpp och skydd — ljust nog för att växa, mjukt nog för att skydda.','Dämpar stark sol och värme så att plantor etablerar sig lugnt, utan brännskador eller stress.','När säsongen vänder tvättas Nixol rent av — ingen flagning, inga rester, inga överraskningar på glaset.'] }],

    ['#light .eyebrow', { nl: 'Hoe het werkt', pl: 'Jak to działa', ro: 'Cum funcționează', de: 'So funktioniert es', fr: 'Comment ça marche', es: 'Cómo funciona', it: 'Come funziona', tr: 'Nasıl çalışır', no: 'Slik virker det', sv: 'Så fungerar det' }],
    ['#light h2', {
      ...
      tr: 'Işıkla <span class="leaf">birlikte çalışan</span> bir gölge', no: 'Skygge som <span class="leaf">samspiller med</span> lyset', sv: 'Skugga som <span class="leaf">samverkar med</span> ljuset' }],
    ['#light .lead', {
      ...
      tr: 'Nixol, içeri giren güneş ışığını bitki örtüsü üzerinde yumuşak ve eşit bir parıltıya dağıtır. Yetiştiriciler istedikleri iklimi elde eder — daha düşük yaprak sıcaklıkları ve daha yumuşak zirveler — bitki ise ihtiyaç duyduğu ışığı almaya devam eder.', no: 'Nixol sprer innkommende sollys til et mykt, jevnt skjær over kulturen. Dyrkere får klimaet de ønsker — lavere bladtemperaturer og mildere topper — mens kulturen fortsatt får lyset den trenger.', sv: 'Nixol sprider inkommande solljus till ett mjukt, jämnt sken över grödan. Odlare får det klimat de vill ha — lägre bladtemperaturer och mildare toppar — medan grödan ändå får det ljus den behöver.' }],
    ['#light .badge', { nl: 'Lichtregulatie, geen verduistering', pl: 'Regulacja światła, nie zaciemnienie', ro: 'Reglarea luminii, nu întunecare', de: 'Lichtregulierung, keine Verdunkelung', fr: 'Régulation de la lumière, pas d\'obscurcissement', es: 'Regulación de la luz, no oscurecimiento', it: 'Regolazione della luce, non oscuramento', tr: 'Işık düzenlemesi, karartma değil', no: 'Lysregulering, ikke blending', sv: 'Ljusreglering, inte mörkläggning' }],
    ['#light .split-list span', {
      ...
      tr: ['Genç bitkilerde ısı stresini ve yanıkları azaltan eşit ışık dağılımı.','Hem cam hem de polikarbonat üzerinde güvenilir performans.','Büyüme sezonuna göre ayarlanır, ardından ışık yumuşadığında çıkarılır.'], no: ['Jevn lysspredning som reduserer varmestress og svidde blader hos unge planter.','Pålitelig ytelse på både glass og polykarbonat.','Tilpasset vekstsesongen, og fjernet så snart lyset blir mildere.'], sv: ['Jämn ljusspridning som minskar värmestress och brännskador hos unga plantor.','Pålitlig prestanda på både glas och polykarbonat.','Anpassad till växtsäsongen, och borttagen när ljuset blir mildare.'] }],

    ['#features .eyebrow', { nl: 'Wat het onderscheidt', pl: 'Co je wyróżnia', ro: 'Ce îl face diferit', de: 'Was es auszeichnet', fr: 'Ce qui le distingue', es: 'Lo que lo distingue', it: 'Ciò che lo distingue', tr: 'Onu farklı kılan', no: 'Det som skiller det ut', sv: 'Det som utmärker det' }],
    ['#features h2', {
      ...
      tr: '<span class="sun">Sera</span> için tasarlandı', no: 'Utviklet for <span class="sun">veksthuset</span>', sv: 'Utvecklad för <span class="sun">växthuset</span>' }],
    ['#features .lead', {
      ...
      tr: 'Yetiştiricilerin bir gölgeleme kaplamasından istediği her şey — ve geride bırakmak istemeyecekleri hiçbir şey.', no: 'Alt dyrkere ber om av et skyggebelegg — og ingenting de vil ha igjen.', sv: 'Allt odlare begär av en skuggbeläggning — och inget de vill ha kvar.' }],
    ['#features .feat b', {
      nl: ['Optimale lichtregulatie','Uitstekende hechting','Weerbestendig','Duurzaam','Laag-emissie & circulair','Snelle applicatie','Volledig verwijderbaar','Bewezen &amp; gecertificeerd'],
      pl: ['Optymalna regulacja światła','Doskonała przyczepność','Odporna na warunki atmosferyczne','Zrównoważona','Niskoemisyjna i obiegowa','Szybka aplikacja','Całkowicie usuwalna','Sprawdzona i certyfikowana'],
      ro: ['Reglare optimă a luminii','Aderență excelentă','Rezistentă la intemperii','Sustenabilă','Cu emisii reduse și circulară','Aplicare rapidă','Complet detașabilă','Dovedită și certificată'],
      de: ['Optimale Lichtregulierung','Ausgezeichnete Haftung','Witterungsbeständig','Nachhaltig','Emissionsarm &amp; zirkulär','Schnelle Applikation','Vollständig entfernbar','Bewährt &amp; zertifiziert'],
      fr: ['Régulation optimale de la lumière','Excellente adhérence','Résistant aux intempéries','Durable','Faibles émissions &amp; circulaire','Application rapide','Entièrement amovible','Éprouvé et certifié'],
      es: ['Regulación óptima de la luz','Excelente adherencia','Resistente a la intemperie','Sostenible','Bajas emisiones y circular','Aplicación rápida','Totalmente eliminable','Probado y certificado'],
      it: ['Regolazione ottimale della luce','Adesione eccellente','Resistente agli agenti atmosferici','Sostenibile','A basse emissioni e circolare','Applicazione rapida','Completamente rimovibile','Provato e certificato'],
      tr: ['Optimal ışık düzenlemesi','Mükemmel yapışma','Hava koşullarına dayanıklı','Sürdürülebilir','Düşük emisyonlu &amp; döngüsel','Hızlı uygulama','Tamamen çıkarılabilir','Kanıtlanmış &amp; sertifikalı'], no: ['Optimal lysregulering','Utmerket heft','Værbestandig','Bærekraftig','Lavutslipp &amp; sirkulær','Rask påføring','Fullt avtakbart','Bevist &amp; sertifisert'], sv: ['Optimal ljusreglering','Utmärkt vidhäftning','Väderbeständig','Hållbar','Låga utsläpp &amp; cirkulär','Snabb applicering','Helt avlägsningsbar','Beprövad &amp; certifierad'] }],
    ['#features .feat span', {
      nl: ['De juiste balans tussen lichtinval en gewasbescherming.','Speciaal ontwikkeld voor glas en polycarbonaat — voorkomt afbladderen.','Bestand tegen regen, UV-straling en temperatuurschommelingen.','Langdurig effect, en eenvoudig te verwijderen aan het einde van het seizoen.','Lage emissies, circulair krijt en veilig voor planten en de mensen die het aanbrengen.','Geschikt voor spuiten, rollen of kwasten — en snel droog.','Laat na reiniging geen residu achter op het glas.','Gemaakt binnen een ISO 9001-, 14001- &amp; 45001-kwaliteits- en veiligheidssysteem.'],
      pl: ['Właściwa równowaga między dostępem światła a ochroną upraw.','Specjalnie opracowana do szkła i poliwęglanu — zapobiega łuszczeniu.','Odporna na deszcz, promieniowanie UV i wahania temperatury.','Długotrwały efekt i łatwa do usunięcia po zakończeniu sezonu.','Niska emisja, na bazie krążącej kredy i bezpieczna dla roślin oraz osób, które ją nakładają.','Nadaje się do natryskiwania, wałkowania lub malowania pędzlem — i szybko schnie.','Nie pozostawia osadu na szkle po umyciu.','Wyprodukowana w systemie jakości i bezpieczeństwa ISO 9001, 14001 i 45001.'],
      ro: ['Echilibrul potrivit între pătrunderea luminii și protecția culturilor.','Special formulată pentru sticlă și policarbonat — previne cojirea.','Rezistentă la ploaie, radiații UV și variații de temperatură.','Efect de lungă durată și ușor de îndepărtat la finalul sezonului.','Emisii reduse, pe bază de cretă circulară și sigură pentru plante și pentru cei care o aplică.','Potrivită pentru pulverizare, aplicare cu rola sau pensula — și se usucă rapid.','Nu lasă reziduuri pe sticlă după curățare.','Realizată într-un sistem de calitate și siguranță ISO 9001, 14001 și 45001.'],
      de: ['Das richtige Gleichgewicht zwischen Lichteinfall und Kulturschutz.','Speziell für Glas und Polycarbonat entwickelt — verhindert Abblättern.','Beständig gegen Regen, UV-Strahlung und Temperaturschwankungen.','Langanhaltende Wirkung und am Saisonende einfach zu entfernen.','Geringe Emissionen, auf Basis zirkulärer Kreide und sicher für Pflanzen und die Anwender.','Geeignet zum Spritzen, Rollen oder Streichen — und schnell trocknend.','Hinterlässt nach der Reinigung keine Rückstände auf dem Glas.','Hergestellt in einem ISO-9001-, 14001- &amp; 45001-Qualitäts- und Sicherheitssystem.'],
      fr: ['Le bon équilibre entre apport de lumière et protection des cultures.','Spécialement développé pour le verre et le polycarbonate — empêche l\'écaillage.','Résistant à la pluie, aux UV et aux variations de température.','Effet durable, et facile à retirer en fin de saison.','Faibles émissions, à base de craie circulaire et sûr pour les plantes et pour ceux qui l\'appliquent.','Adapté à la pulvérisation, au rouleau ou au pinceau — et séchage rapide.','Ne laisse aucun résidu sur le verre après nettoyage.','Fabriqué selon un système qualité et sécurité ISO 9001, 14001 et 45001.'],
      es: ['El equilibrio justo entre entrada de luz y protección del cultivo.','Especialmente desarrollado para vidrio y policarbonato — evita la descamación.','Resistente a la lluvia, la radiación UV y las variaciones de temperatura.','Efecto duradero y fácil de retirar al final de la temporada.','Bajas emisiones, a base de tiza circular y seguro para las plantas y para quienes la aplican.','Apto para pulverización, rodillo o brocha — y de secado rápido.','No deja residuos en el vidrio tras la limpieza.','Fabricado dentro de un sistema de calidad y seguridad ISO 9001, 14001 y 45001.'],
      it: ['Il giusto equilibrio tra apporto di luce e protezione della coltura.','Sviluppato appositamente per vetro e policarbonato — previene lo sfaldamento.','Resistente a pioggia, raggi UV e sbalzi di temperatura.','Effetto duraturo e facile da rimuovere a fine stagione.','Basse emissioni, a base di gesso circolare e sicuro per le piante e per chi lo applica.','Adatto a spruzzo, rullo o pennello — e ad asciugatura rapida.','Non lascia residui sul vetro dopo la pulizia.','Realizzato all\'interno di un sistema qualità e sicurezza ISO 9001, 14001 e 45001.'],
      tr: ['Işık girişi ile bitki koruması arasındaki doğru denge.','Cam ve polikarbonat için özel olarak geliştirildi — dökülmeyi önler.','Yağmura, UV ışınlarına ve sıcaklık değişimlerine dayanıklı.','Uzun süreli etki ve sezon sonunda kolayca çıkarılabilir.','Düşük emisyonlu, döngüsel tebeşir bazlı ve bitkiler ile onu uygulayanlar için güvenli.','Püskürtme, rulo veya fırça için uygun — ve hızlı kuruyan.','Temizlikten sonra camda kalıntı bırakmaz.','ISO 9001, 14001 &amp; 45001 kalite ve güvenlik sistemi içinde üretilmiştir.'], no: ['Den rette balansen mellom lysinnslipp og kulturbeskyttelse.','Spesialutviklet for glass og polykarbonat — hindrer flassing.','Bestandig mot regn, UV-stråling og temperatursvingninger.','Langvarig effekt, og enkel å fjerne ved sesongslutt.','Lave utslipp, sirkulært krittbasert og trygt for planter og dem som påfører det.','Egnet for sprøyting, rulling eller pensling — og hurtigtørkende.','Etterlater ingen rester på glasset etter rengjøring.','Laget innenfor et ISO 9001-, 14001- &amp; 45001-kvalitets- og sikkerhetssystem.'], sv: ['Den rätta balansen mellan ljusinsläpp och grödskydd.','Specialutvecklad för glas och polykarbonat — förhindrar flagning.','Beständig mot regn, UV-strålning och temperaturväxlingar.','Långvarig effekt, och lätt att avlägsna i slutet av säsongen.','Låga utsläpp, cirkulär kritbaserad och säker för växter och dem som applicerar den.','Lämplig för sprutning, rollning eller penselapplicering — och snabbtorkande.','Lämnar inga rester på glaset efter rengöring.','Tillverkad inom ett ISO 9001-, 14001- &amp; 45001-kvalitets- och säkerhetssystem.'] }],

    ['#chalk .eyebrow', { nl: 'Circulair &amp; schoon', pl: 'Obiegowa i czysta', ro: 'Circulară și curată', de: 'Zirkulär &amp; sauber', fr: 'Circulaire et propre', es: 'Circular y limpio', it: 'Circolare e pulito', tr: 'Döngüsel &amp; temiz', no: 'Sirkulær &amp; ren', sv: 'Cirkulär &amp; ren' }],
    ['#chalk h2', {
      ...
      tr: '<span class="leaf">Döngüsel tebeşir</span> üzerine kurulu', no: 'Bygget på <span class="leaf">sirkulært kritt</span>', sv: 'Byggd på <span class="leaf">cirkulär krita</span>' }],
    ['#chalk .lead', {
      ...
      tr: 'Nixol, döngüsel tebeşire dayanır — doğada bol bulunan, geri dönüştürülmüş bir mineral. Bir sezon boyunca görevini yapar, sonra tertemiz geri çekilir ve camı ile çevreyi bulduğu gibi bırakır.', no: 'Nixol er basert på sirkulært kritt — et naturlig rikelig, gjenvunnet mineral. Det gjør jobben sin en sesong og vender deretter rent tilbake, og etterlater glasset og miljøet slik det fant dem.', sv: 'Nixol är baserad på cirkulär krita — ett naturligt rikligt, återvunnet mineral. Den gör sitt jobb under en säsong och återgår sedan rent, och lämnar glaset och miljön som den fann dem.' }],
    ['#chalk .stat .n', {
      nl: ['Volledig','Laag','Circulair'], pl: ['W pełni','Niska','Obiegowa'], ro: ['Complet','Redus','Circular'], de: ['Vollständig','Gering','Zirkulär'], fr: ['Entièrement','Faible','Circulaire'], es: ['Totalmente','Bajas','Circular'], it: ['Completamente','Basse','Circolare'], tr: ['Tamamen','Düşük','Döngüsel'], no: ['Fullt','Lav','Sirkulær'], sv: ['Helt','Låg','Cirkulär'] }],
    ['#chalk .stat .l', {
      ...
      tr: ['Çıkarılabilir — kalıntı bırakmadan yıkanıp gider.','Emisyon — bitkiler ve onu uygulayan kişiler için güvenli.','Geri dönüştürülmüş mineral kaynaktan tebeşir bazlı formül.'], no: ['Avtakbart — vaskes av uten rester.','Utslipp — trygt for planter og dem som påfører det.','Krittbasert formel fra en gjenvunnet mineralkilde.'], sv: ['Avlägsningsbar — tvättas av utan rester.','Utsläpp — säker för växter och dem som applicerar den.','Kritbaserad formel från en återvunnen mineralkälla.'] }],
    ...
    ['#apply h2', {
      ...
      tr: '<span class="sun">Cam altında</span> yetiştirmek için yapıldı', no: 'Laget for å dyrke <span class="sun">under glass</span>', sv: 'Gjord för att odla <span class="sun">under glas</span>' }],
    ['#apply .lead', {
      ...
      tr: 'Bahçecilikte seralar için bir gölgeleme boyası — hem yeni yapıya hem de mevcut seraların bakımına uygun.', no: 'En skyggemaling for veksthus i hagebruket — egnet for nybygg og for vedlikehold av eksisterende veksthus.', sv: 'En skuggfärg för växthus inom trädgårdsodling — lämplig för nybygge och för underhåll av befintliga växthus.' }],
    ['#apply .badge', { nl: 'Tuinbouw · Glas &amp; polycarbonaat', pl: 'Ogrodnictwo · Szkło i poliwęglan', ro: 'Horticultură · Sticlă și policarbonat', de: 'Gartenbau · Glas &amp; Polycarbonat', fr: 'Horticulture · Verre et polycarbonate', es: 'Horticultura · Vidrio y policarbonato', it: 'Orticoltura · Vetro e policarbonato', tr: 'Bahçecilik · Cam &amp; polikarbonat', no: 'Hagebruk · Glass &amp; polykarbonat', sv: 'Trädgårdsodling · Glas &amp; polykarbonat' }],
    ['#apply .sheet-row b', {
      ...
      tr: ['Yüzeyler','Uygulama','Kullanım','Çıkarma'], no: ['Underlag','Påføring','Bruk','Fjerning'], sv: ['Underlag','Applicering','Användning','Borttagning'] }],
    ['#apply .sheet-row span', {
      ...
      tr: ['Cam ve polikarbonat sera çatıları ve duvarları.','Püskürtme, rulo veya fırça — kısa döngü için hızlı kuruma.','Yeni yapı ve mevcut seraların bakımı.','Tamamen çıkarılabilir, temizlikten sonra kalıntı bırakmaz.'], no: ['Tak og vegger av glass og polykarbonat på veksthus.','Sprøyte, rull eller pensel — hurtigtørkende for kort gjennomføringstid.','Nybygg &amp; vedlikehold av eksisterende veksthus.','Fullt avtakbart, etterlater ingen rester etter rengjøring.'], sv: ['Tak och väggar av glas och polykarbonat på växthus.','Spruta, rulle eller pensel — snabbtorkande för kort genomloppstid.','Nybygge &amp; underhåll av befintliga växthus.','Helt avlägsningsbar, lämnar inga rester efter rengöring.'] }],
    ...
    ['#certs h2', {
      ...
      tr: 'Kalite, çevre <span class="leaf">&amp; güvenlik</span>', no: 'Kvalitet, miljø <span class="leaf">&amp; sikkerhet</span>', sv: 'Kvalitet, miljö <span class="leaf">&amp; säkerhet</span>' }],
    ['#certs .lead', {
    ...
    ['.cta-card .eyebrow', { nl: 'Probeer het zelf', pl: 'Wypróbuj sam', ro: 'Încearcă singur', de: 'Selbst ausprobieren', fr: 'Essayez par vous-même', es: 'Pruébalo tú mismo', it: 'Provalo tu stesso', tr: 'Kendiniz deneyin', no: 'Prøv det selv', sv: 'Prova själv' }],
    ['.cta-card h2', { nl: 'Vraag een gratis monster aan', pl: 'Poproś o darmową próbkę', ro: 'Cere o mostră gratuită', de: 'Kostenloses Muster anfordern', fr: 'Demander un échantillon gratuit', es: 'Pide una muestra gratuita', it: 'Richiedi un campione gratuito', tr: 'Ücretsiz numune talep edin', no: 'Be om en gratis prøve', sv: 'Beställ ett gratisprov' }],
    ['.cta-card p', {
      ...
      tr: 'Nixol Transparant hakkında daha fazla bilgi, teknik destek veya ücretsiz numune edinin. Ekibimiz, bitkileriniz için en iyi iklimi oluşturmanıza memnuniyetle yardımcı olur.', no: 'Få mer informasjon, teknisk støtte eller en gratis prøve av Nixol Transparent. Teamet vårt hjelper deg gjerne med å skape det beste klimaet for vekstene dine.', sv: 'Få mer information, teknisk support eller ett gratisprov av Nixol Transparent. Vårt team hjälper dig gärna att skapa det bästa klimatet för dina grödor.' }],
    ...
    ['.foot-claim', {
      ...
      tr: 'Berrak sonuçlar — genç bitkileri koruyan ve sonra yıkanıp giden bir gölge.', no: 'Klare resultater — skygge som beskytter unge vekster og deretter vaskes bort.', sv: 'Tydliga resultat — skugga som skyddar unga grödor och sedan tvättas bort.' }],
    ['.foot-grid div:nth-child(2) a', {
      ...
      tr: ['Nasıl çalışır','Özellikler','Uygulamalar','Numune talep edin'], no: ['Slik virker det','Egenskaper','Bruksområder','Be om en prøve'], sv: ['Så fungerar det','Egenskaper','Användningsområden','Beställ ett prov'] }],
    ['.foot-bottom span', {
      ...
      tr: ["© Nixol · bir Baril Group markası",'Berrak sonuçlar, sezon sezon üstüne.'], no: ['© Nixol · et merke fra Baril Group','Klare resultater, sesong etter sesong.'], sv: ['© Nixol · ett varumärke från Baril Group','Tydliga resultat, säsong efter säsong.'] }]
  ];
