...
(() => {
  ...
  const MAP = [
    ...
    ['#features .feat b', {
      ...
      tr: ['Optimal ışık düzenlemesi','Mükemmel yapışma','Hava koşullarına dayanıklı','Sürdürülebilir','Düşük emisyonlu &amp; döngüsel','Hızlı uygulama','Tamamen çıkarılabilir','Kanıtlanmış &amp; sertifikalı'] }],
    ['#features .feat span', {
    ...
    ['#chalk .stat .n', {
      nl: ['Volledig','Laag','Circulair'], pl: ['W pełni','Niska','Obiegowa'], ro: ['Complet','Redus','Circular'], de: ['Vollständig','Gering','Zirkulär'], fr: ['Entièrement','Faible','Circulaire'], es: ['Totalmente','Bajas','Circular'], it: ['Completamente','Basse','Circolare'], tr: ['Tamamen','Düşük','Döngüsel'] }],
    ['#chalk .stat .l', {
