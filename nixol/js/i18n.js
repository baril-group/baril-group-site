...
(() => {
  ...
  const MAP = [
    ...
    ['header .hero-cta .btn-solid', { nl: 'Hoe het werkt', pl: 'Jak to działa', ro: 'Cum funcționează', de: 'So funktioniert es', fr: 'Comment ça marche', es: 'Cómo funciona', it: 'Come funziona' }],
    ['header .hero-cta .btn-ghost', { nl: 'Vraag een gratis monster aan', pl: 'Poproś o darmową próbkę', ro: 'Cere o mostră gratuită', de: 'Kostenloses Muster anfordern', fr: 'Demander un échantillon gratuit', es: 'Pide una muestra gratuita', it: 'Richiedi un campione gratuito' }],
    ...
    ['#mission .eyebrow', { nl: 'Waarom Nixol', pl: 'Dlaczego Nixol', ro: 'De ce Nixol', de: 'Warum Nixol', fr: 'Pourquoi Nixol', es: 'Por qué Nixol', it: 'Perché Nixol' }],
    ['.mission-quote', {
    ...
    ['#light .eyebrow', { nl: 'Hoe het werkt', pl: 'Jak to działa', ro: 'Cum funcționează', de: 'So funktioniert es', fr: 'Comment ça marche', es: 'Cómo funciona', it: 'Come funziona' }],
    ['#light h2', {
    ...
    ['#light .badge', { nl: 'Lichtregulatie, geen verduistering', pl: 'Regulacja światła, nie zaciemnienie', ro: 'Reglarea luminii, nu întunecare', de: 'Lichtregulierung, keine Verdunkelung', fr: 'Régulation de la lumière, pas d\'obscurcissement', es: 'Regulación de la luz, no oscurecimiento', it: 'Regolazione della luce, non oscuramento' }],
    ...
    ['#features .eyebrow', { nl: 'Wat het onderscheidt', pl: 'Co je wyróżnia', ro: 'Ce îl face diferit', de: 'Was es auszeichnet', fr: 'Ce qui le distingue', es: 'Lo que lo distingue', it: 'Ciò che lo distingue' }],
    ['#features h2', {
    ...
    ['#chalk .eyebrow', { nl: 'Circulair &amp; schoon', pl: 'Obiegowa i czysta', ro: 'Circulară și curată', de: 'Zirkulär &amp; sauber', fr: 'Circulaire et propre', es: 'Circular y limpio', it: 'Circolare e pulito' }],
    ['#chalk h2', {
    ...
    ['#chalk .stat .n', {
      nl: ['100%','Laag','Circulair'], pl: ['100%','Niska','Obiegowa'], ro: ['100%','Redus','Circular'], de: ['100%','Gering','Zirkulär'], fr: ['100%','Faible','Circulaire'], es: ['100%','Bajas','Circular'], it: ['100%','Basse','Circolare'] }],
    ['#chalk .stat .l', {
    ...
    ['#apply .badge', { nl: 'Tuinbouw · Glas &amp; polycarbonaat', pl: 'Ogrodnictwo · Szkło i poliwęglan', ro: 'Horticultură · Sticlă și policarbonat', de: 'Gartenbau · Glas &amp; Polycarbonat', fr: 'Horticulture · Verre et polycarbonate', es: 'Horticultura · Vidrio y policarbonato', it: 'Orticoltura · Vetro e policarbonato' }],
    ['#apply .sheet-row b', {
    ...
    ['#certs .eyebrow', { nl: 'Certificeringen &amp; keurmerken', pl: 'Certyfikaty i znaki jakości', ro: 'Certificări și mărci de calitate', de: 'Zertifizierungen &amp; Gütesiegel', fr: 'Certifications et labels', es: 'Certificaciones y sellos', it: 'Certificazioni e marchi' }],
    ['#certs h2', {
    ...
    ['.cta-card .eyebrow', { nl: 'Probeer het zelf', pl: 'Wypróbuj sam', ro: 'Încearcă singur', de: 'Selbst ausprobieren', fr: 'Essayez par vous-même', es: 'Pruébalo tú mismo', it: 'Provalo tu stesso' }],
    ['.cta-card h2', { nl: 'Vraag een gratis monster aan', pl: 'Poproś o darmową próbkę', ro: 'Cere o mostră gratuită', de: 'Kostenloses Muster anfordern', fr: 'Demander un échantillon gratuit', es: 'Pide una muestra gratuita', it: 'Richiedi un campione gratuito' }],
    ['.cta-card p', {
    ...
    ['.cta-card .btn-solid', { nl: 'Contact &amp; vestigingen', pl: 'Kontakt i biura', ro: 'Contact și birouri', de: 'Kontakt &amp; Standorte', fr: 'Contact et sites', es: 'Contacto y sedes', it: 'Contatto e sedi' }],
