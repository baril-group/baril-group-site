...
(() => {
  ...
  const MAP = [
    ...
    ['.navlinks a', {
      ...
      tr: ['Neden Fortis Coatings','Ürünler','Performans','Uygulamalar','İletişim'], no: ['Hvorfor Fortis Coatings','Produkter','Ytelse','Bruksområder','Kontakt'], sv: ['Varför Fortis Coatings','Produkter','Prestanda','Användningsområden','Kontakt'] }],
    ['header .eyebrow .eb-txt', {
      ...
      tr: 'Fortis Coatings — Metal için endüstriyel kaplamalar · Bir Baril Group markası', no: 'Fortis Coatings — Industrielle metallbelegg · Et merke fra Baril Group', sv: 'Fortis Coatings — Industriella metallbeläggningar · Ett varumärke från Baril Group' }],
    ['header h1', {
      ...
      tr: 'Metal için<br><span class="acc">çelik gibi</span><br>koruma', no: 'Jernsterk<br><span class="acc">beskyttelse</span><br>for metall', sv: 'Järnstarkt<br><span class="acc">skydd</span><br>för metall' }],
    ['.hero-sub', {
      ...
      tr: 'Her türlü atmosferik koşulda <strong>maksimum yüzey koruması</strong> sağlayan endüstriyel astarlar ve son katlar — metal işleme endüstrisi ve hızlı endüstriyel uygulama için tasarlandı.', no: 'Industrielle primere og topplag som gir <strong>maksimal overflatebeskyttelse</strong> under alle atmosfæriske forhold — laget for metallforedlingsindustrien og rask industriell påføring.', sv: 'Industriella primers och topplager som ger <strong>maximalt ytskydd</strong> under alla atmosfäriska förhållanden — gjorda för metallbearbetningsindustrin och snabb industriell applicering.' }],
    ...
    ['.hero-foot span:first-child', {
      ...
      tr: 'Alkid · Su bazlı · Epoksi · Poliüretan', no: 'Alkyd · Vannbasert · Epoksy · Polyuretan', sv: 'Alkyd · Vattenburen · Epoxi · Polyuretan' }],
    ['.scroll-hint', { nl: 'Scroll', pl: 'Przewiń', ro: 'Derulează', de: 'Scrollen', fr: 'Défiler', es: 'Desliza', it: 'Scorri', tr: 'Kaydır', no: 'Bla', sv: 'Skrolla' }],

    ['#mission .eyebrow', { nl: 'Waarom Fortis Coatings', pl: 'Dlaczego Fortis Coatings', ro: 'De ce Fortis Coatings', de: 'Warum Fortis Coatings', fr: 'Pourquoi Fortis Coatings', es: 'Por qué Fortis Coatings', it: 'Perché Fortis Coatings', tr: 'Neden Fortis Coatings', no: 'Hvorfor Fortis Coatings', sv: 'Varför Fortis Coatings' }],
    ['.mission-quote', {
      ...
      tr: 'Metal, kalıcı bir koruma hak eder. Fortis Coatings <em>çelik gibi</em> astarlar ve son katlar sunar — her türlü atmosferik koşulda maksimum yüzey koruması için geliştirildi ve hızlı endüstriyel uygulamaya hazır.', no: 'Metall fortjener beskyttelse som varer. Fortis Coatings leverer <em>jernsterke</em> primere og topplag — utviklet for maksimal overflatebeskyttelse under alle atmosfæriske forhold, og klare for rask industriell påføring.', sv: 'Metall förtjänar skydd som håller. Fortis Coatings levererar <em>järnstarka</em> primers och topplager — utvecklade för maximalt ytskydd under alla atmosfäriska förhållanden, och redo för snabb industriell applicering.' }],
    ['#mission .mm b', {
      ...
      tr: ['Maksimum koruma','Boya hattı için tasarlandı','Her renk, her parlaklık derecesi'], no: ['Maksimal beskyttelse','Laget for lakklinjen','Enhver farge, enhver glans'], sv: ['Maximalt skydd','Gjord för lacklinjen','Vilken färg som helst, vilken glans som helst'] }],
    ['#mission .mm span', {
      ...
      tr: ['Metale her türlü atmosferik koşulda maksimum yüzey koruması sağlayan endüstriyel astarlar ve son katlar.','Otomatik boya hatları ve geleneksel püskürtme teknikleri için uygun — hızlı elektrostatik ıslak-üstüne-ıslak uygulama için mükemmel.','Baril\'in evrensel, yüksek konsantrasyonlu renk pastalarıyla renklendirilebilir; 10, 30, 60 ve tam parlaklık derecelerinde alkid ve PU sistemleri.'], no: ['Industrielle primere og topplag som gir metall maksimal overflatebeskyttelse under alle atmosfæriske forhold.','Egnet for automatiske lakklinjer og konvensjonell sprøyting — perfekt for rask elektrostatisk vått-i-vått-påføring.','Kan innfarges med Barils universelle høykonsentrerte fargepastaer; alkyd- og PU-systemer i glansgrader 10, 30, 60 og full gloss.'], sv: ['Industriella primers och topplager som ger metall maximalt ytskydd under alla atmosfäriska förhållanden.','Lämpliga för automatiska lacklinjer och konventionell sprutning — perfekt för snabb elektrostatisk våt-i-våt-applicering.','Kan färgsättas med Barils universella högkoncentrerade färgpastor; alkyd- och PU-system i glansgrader 10, 30, 60 och full gloss.'] }],
    ...
    ['#products h2', {
      ...
      tr: 'Dört sistem, <span class="acc">tek standart</span>', no: 'Fire systemer, <span class="acc">én standard</span>', sv: 'Fyra system, <span class="acc">en standard</span>' }],
    ['#products .lead', {
      ...
      tr: 'Fortis Coatings ürün yelpazesi, endüstriyel metal son işlemlerinin her adımını kapsar — astarlar ve son katlar, solvent bazlı ve su bazlı, boya hattının gereksinimlerine göre ayarlanmış.', no: 'Fortis Coatings-sortimentet dekker hvert trinn i industriell metallfinish — primere og topplag, løsemiddelbaserte og vannbaserte, tilpasset kravene på lakklinjen.', sv: 'Fortis Coatings-sortimentet täcker varje steg i industriell metallfinish — primers och topplager, lösningsmedelsburna och vattenburna, anpassade till lacklinjens krav.' }],
    ['#products .feat .prod-tag', {
      ...
      tr: ['Alkid · 1K','Su bazlı','Epoksi astar','Poliüretan · 2K'], no: ['Alkyd · 1K','Vannbasert','Epoksy-primer','Polyuretan · 2K'], sv: ['Alkyd · 1K','Vattenburen','Epoxi-primer','Polyuretan · 2K'] }],
    ['#products .feat span:last-child', {
      ...
      tr: ['Çok çeşitli nesnelerin verimli endüstriyel son işlemi için hızlı, tek bileşenli alkid son katları.','Dayanıklılıktan ödün vermeden sürdürülebilir endüstriyel koruma sağlayan düşük emisyonlu su bazlı kaplamalar.','Demir ve demir dışı metaller üzerinde dayanıklı bir temel oluşturan yüksek yapışmalı epoksi astarlar.','Maksimum dayanıklılık, parlaklık korunumu ve kimyasal direnç için iki bileşenli poliüretan son katları.'], no: ['Raske, énkomponents alkyd-topplag for effektiv industriell finish av ulike objekter.','Vannbaserte belegg med lav emisjon for bærekraftig industriell beskyttelse, uten å gå på akkord med slitestyrken.','Heftsterke epoksy-primere som legger et slitesterkt underlag på jern- og ikke-jernholdige metaller.','Tokomponents polyuretan-topplag for maksimal slitestyrke, glansbevaring og kjemisk bestandighet.'], sv: ['Snabba, enkomponents alkyd-topplager för effektiv industriell finish av olika objekt.','Vattenburna beläggningar med låg emission för hållbart industriellt skydd, utan att tumma på hållbarheten.','Vidhäftningsstarka epoxi-primers som lägger ett hållbart underlag på järn- och icke-järnmetaller.','Tvåkomponents polyuretan-topplager för maximal hållbarhet, glansbevarande och kemisk beständighet.'] }],
    ...
    ['#performance h2', {
      ...
      tr: '<span class="acc">Boya hattı</span> için tasarlandı', no: 'Utviklet for <span class="acc">lakklinjen</span>', sv: 'Utvecklad för <span class="acc">lacklinjen</span>' }],
    ['#performance .lead', {
      ...
      tr: 'Fortis Coatings\'in endüstriyel astarları ve son katları, her türlü atmosferik koşulda maksimum yüzey koruması sunar — modern üretim hatlarında çalışmak için tasarlandı.', no: 'De industrielle primerne og topplagene fra Fortis Coatings gir maksimal overflatebeskyttelse under alle atmosfæriske forhold — bygget for å gå på moderne produksjonslinjer.', sv: 'De industriella primers och topplager från Fortis Coatings ger maximalt ytskydd under alla atmosfäriska förhållanden — byggda för att köra på moderna produktionslinjer.' }],
    ['#performance .pills span', {
      ...
      tr: ['Demir &amp; demir dışı','Parlaklık 10 / 30 / 60 / Tam','Elektrostatik','Islak-üstüne-ıslak'], no: ['Jern &amp; ikke-jern','Glans 10 / 30 / 60 / Full','Elektrostatisk','Vått-i-vått'], sv: ['Järn &amp; icke-järn','Glans 10 / 30 / 60 / Full','Elektrostatisk','Våt-i-våt'] }],
    ['#performance .feat b', {
      ...
      tr: ['Atmosferik dayanıklılık','Elektrostatik ıslak-üstüne-ıslak','Boya hattı &amp; geleneksel','Her renk','Özel parlaklık','Sürdürülebilir tasarım'], no: ['Atmosfærisk bestandighet','Elektrostatisk vått-i-vått','Lakklinje &amp; konvensjonelt','Enhver farge','Glans etter spec','Slitesterk fra design'], sv: ['Atmosfärisk beständighet','Elektrostatisk våt-i-våt','Lacklinje &amp; konventionellt','Vilken färg som helst','Glans enligt spec','Hållbar från grunden'] }],
    ['#performance .feat span', {
      ...
      tr: ['Her türlü atmosferik koşulda, iç ve dış mekanda maksimum yüzey koruması.','Yüksek verim için hızlı elektrostatik ıslak-üstüne-ıslak uygulamaya mükemmel uyum.','Otomatik boya hatları için tasarlandı ve geleneksel püskürtme teknikleriyle de aynı derecede uyumlu.','Baril\'in evrensel, yüksek konsantrasyonlu renk pastalarıyla nesnelerinizi istediğiniz her renge boyayın.','10, 30, 60 ve tam parlaklıkta sunulan alkid ve poliüretan boya sistemleri.','Metal nesneleri kalıcı olarak koruyan ve karbon ayak izlerini azaltan astarlar ve son katlar.'], no: ['Maksimal overflatebeskyttelse under alle atmosfæriske forhold, inne og ute.','Perfekt egnet for rask elektrostatisk vått-i-vått-påføring for høy gjennomstrømning.','Laget for automatiske lakklinjer, og like hjemme med konvensjonelle sprøyteteknikker.','Sprøyt objektene dine i enhver farge med Barils universelle høykonsentrerte fargepastaer.','Alkyd- og polyuretan-laksystemer, tilgjengelige i glans 10, 30, 60 og full gloss.','Primere og topplag som beskytter metallobjekter slitesterkt og samtidig reduserer fotavtrykket.'], sv: ['Maximalt ytskydd under alla atmosfäriska förhållanden, inomhus och ute.','Perfekt lämpad för snabb elektrostatisk våt-i-våt-applicering för hög genomströmning.','Gjord för automatiska lacklinjer, och lika hemma med konventionella spruttekniker.','Spruta dina objekt i vilken färg som helst med Barils universella högkoncentrerade färgpastor.','Alkyd- och polyuretan-lacksystem, tillgängliga i glans 10, 30, 60 och full gloss.','Primers och topplager som skyddar metallobjekt hållbart och samtidigt minskar deras fotavtryck.'] }],
    ...
    ['#apply h2', {
      ...
      tr: '<span class="acc">Metal işleme endüstrisi</span><br>için kaplamalar', no: 'Belegg for<br><span class="acc">metallforedlingsindustrien</span>', sv: 'Beläggningar för<br><span class="acc">metallbearbetningsindustrin</span>' }],
    ['#apply .lead', {
      ...
      tr: 'Fortis Coatings kaplamalarını Fortis Coatings bayi ağı aracılığıyla metal işleme endüstrisine sunuyoruz — her metal nesne için çelik gibi boya sistemleri.', no: 'Vi leverer Fortis Coatings-produkter til metallforedlingsindustrien gjennom Fortis Coatings-forhandlernettverket — jernsterke malingssystemer for alle slags metallobjekter.', sv: 'Vi levererar Fortis Coatings-produkter till metallbearbetningsindustrin via Fortis Coatings-återförsäljarnätverket — järnstarka färgsystem för alla slags metallobjekt.' }],
    ['#apply .sheet-row b', {
      ...
      tr: ['Metal işleme','Makine yapımı','Mobil makineler','Vinç &amp; asansör','Konteyner &amp; çit','Mobilya &amp; plastik'], no: ['Metallbearbeiding','Maskinbygging','Mobile maskiner','Kran &amp; løft','Containere &amp; gjerder','Møbler &amp; plast'], sv: ['Metallbearbetning','Maskinbyggnad','Mobila maskiner','Kran &amp; lyft','Containrar &amp; staket','Möbler &amp; plast'] }],
    ['#apply .sheet-row span', {
      ...
      tr: ['Metal işleme endüstrisi ve genel endüstriyel son işlemler için kaplamalar.','Makine ve ekipman yapımı için kaplamalar.','Tarım makineleri ve hafriyat makineleri için kaplamalar.','Vinç ve asansör yapımı için kaplamalar.','Konteyner yapımı ve çitler için kaplamalar.','Kent ve park mobilyaları ve plastik işleme için kaplamalar.'], no: ['Belegg for metallforedlingsindustrien og generell industriell finish.','Belegg for maskin- og apparatbygging.','Belegg for landbruksmaskiner og anleggsmaskiner.','Belegg for kran- og løftebygging.','Belegg for containerbygging og gjerder.','Belegg for gate- og parkmøbler og plastbearbeiding.'], sv: ['Beläggningar för metallbearbetningsindustrin och allmän industriell finish.','Beläggningar för maskin- och apparatbyggnad.','Beläggningar för lantbruksmaskiner och anläggningsmaskiner.','Beläggningar för kran- och lyftbyggnad.','Beläggningar för containerbyggnad och staket.','Beläggningar för gatu- och parkmöbler och plastbearbetning.'] }],
    ...
    ['#contact h2', { nl: 'Vind een Fortis Coatings-dealer', pl: 'Znajdź dealera Fortis Coatings', ro: 'Găsește un dealer Fortis Coatings', de: 'Einen Fortis Coatings-Händler finden', fr: 'Trouver un distributeur Fortis Coatings', es: 'Encuentra un distribuidor Fortis Coatings', it: 'Trova un rivenditore Fortis Coatings', tr: 'Bir Fortis Coatings bayisi bulun', no: 'Finn en Fortis Coatings-forhandler', sv: 'Hitta en Fortis Coatings-återförsäljare' }],
    ['#contact p', {
      ...
      tr: 'Fortis Coatings serisinin çelik gibi boya sistemlerini keşfedin ve bölgenizdeki bir bayiyi bulun — ya da boya hattınız hakkında kaplama uzmanlarımıza danışın.', no: 'Oppdag de jernsterke malingssystemene i Fortis Coatings-sortimentet og finn en forhandler i din region — eller snakk med coatingekspertene våre om lakklinjen din.', sv: 'Upptäck de järnstarka färgsystemen i Fortis Coatings-sortimentet och hitta en återförsäljare i din region — eller prata med våra beläggningsexperter om din lacklinje.' }],
    ...
    ['.foot-claim', {
      ...
      tr: 'Metal için çelik gibi endüstriyel kaplamalar.', no: 'Jernsterke industrielle belegg for metall.', sv: 'Järnstarka industriella beläggningar för metall.' }],
    ['footer h3', {
    ...
    ['.foot-bottom span', {
      ...
      tr: ["© Fortis Coatings · bir Baril Group markası",'Metal için çelik gibi koruma.'], no: ['© Fortis Coatings · et merke fra Baril Group','Jernsterk beskyttelse for metall.'], sv: ['© Fortis Coatings · ett varumärke från Baril Group','Järnstarkt skydd för metall.'] }],
    ...
    ['#certs h2', {
      ...
      tr: 'Kalite, çevre <span class="acc">&amp; güvenlik</span>', no: 'Kvalitet, miljø <span class="acc">&amp; sikkerhet</span>', sv: 'Kvalitet, miljö <span class="acc">&amp; säkerhet</span>' }],
    ['#certs .lead', {
