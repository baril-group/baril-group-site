...
(() => {
  ...
  const MAP = [
    ...
    ['#brands h2', { nl: 'Eén missie,<br>vijf merken', pl: 'Jedna misja,<br>pięć marek', ro: 'O misiune,<br>cinci mărci' }],
    ...
    ['.brand .tag', { nl: ['Voor de industrie', 'Voor de vakschilder', 'Voor thuis', 'Voor de tuinbouw', 'Voor kleur'], pl: ['Dla przemysłu', 'Dla profesjonalnego malarza', 'Do domu', 'Dla ogrodnictwa', 'Dla koloru'], ro: ['Pentru industrie', 'Pentru zugravul profesionist', 'Pentru casă', 'Pentru horticultură', 'Pentru culoare'] }],
    ...
    ['.spec b', { nl: ['Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment'], pl: ['Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment'], ro: ['Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă'] }],
