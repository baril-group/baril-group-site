...
(() => {
  ...
  const MAP = [
    ...
    ['#story .sec-head p:last-child', {
      ...
      ro: 'Baril a început în 1982 ca un mic producător de vopsele în Moerkapelle — o mână de oameni dedicați într-un depozit. Patru decenii mai târziu, este un producător internațional de acoperiri cu fabrici în Olanda și Statele Unite, condus în continuare de familiile Duijghuisen & Harmon. Constanta: curajul de a face alegeri diferite, cu antreprenoriatul responsabil la bază.',
    ...
    ['.brand .tag', {"nl":["Voor de landbouw","Voor refinish","Voor de industrie","Voor de vakschilder","Voor thuis","Voor wagenparken","Voor metaal","Voor de tuinbouw","Voor vloeren","Voor kleur"],"pl":["Dla rolnictwa","Do renowacji","Dla przemysłu","Dla profesjonalnego malarza","Do domu","Dla flot","Do metalu","Dla ogrodnictwa","Do podłóg","Dla koloru"],"ro":["Pentru agricultură","Pentru refinisare","Pentru industrie","Pentru zugravul profesionist","Pentru casă","Pentru flote","Pentru metal","Pentru horticultură","Pentru pardoseli","Pentru culoare"],"de":["Für die Landwirtschaft","Für Refinish","Für die Industrie","Für den Profimaler","Für zu Hause","Für Fuhrparks","Für Metall","Für den Gartenbau","Für Böden","Für Farbe"],"fr":["Pour l'agriculture","Pour le refinish","Pour l'industrie","Pour le peintre pro","Pour la maison","Pour les flottes","Pour le métal","Pour l'horticulture","Pour les sols","Pour la couleur"],"es":["Para la agricultura","Para el repintado","Para la industria","Para el pintor pro","Para el hogar","Para flotas","Para el metal","Para la horticultura","Para suelos","Para el color"],"it":["Per l'agricoltura","Per il refinish","Per l'industria","Per l'imbianchino pro","Per la casa","Per le flotte","Per il metallo","Per l'orticoltura","Per i pavimenti","Per il colore"],"tr":["Tarım için","Refinish için","Sanayi için","Profesyonel boyacı için","Ev için","Filolar için","Metal için","Bahçecilik için","Zeminler için","Renk için"]}],
    ['.brand > div:first-child > p:not(.tag)', {"nl":["Een roestwerende coating die direct over bestaande roest gaat — zonder stralen. Hij kapselt corrosie in en beschermt landbouwmachines, vrachtwagens en constructies voor de lange termijn.","Een complete automotive refinish-lijn — blanke lakken, primers, sealers, fabrieksmatig verpakte kleuren en roestwering voor reparaties aan autobody, vrachtwagens en materieel.","Hoogwaardige industriële coatings en bouwverven. Dunne-laag-bescherming voor staal en infrastructuur, OEM en metaalindustrie, marine & offshore — ontwikkeld om materialen langer te laten meegaan met minder verf.","Een compleet biobased verfsysteem voor de professionele schilder. Plantaardige chemie met EU Ecolabel en Cradle to Cradle-certificering — de groenste verf, mengbaar in elke kleur.","Plantaardige muur- en lakverf voor iedereen. Kleurcollecties samengesteld door experts, mengbaar in elke kleur van de regenboog — online en in het schap bij Karwei.","Een geïntegreerd refinish-systeem voor het commerciële transport — corrosiebestendige primers, hoogglanzende urethaan toplagen en een intermix-kleurenprogramma met nauwkeurige kleuraanpassing.","IJzersterke industriële coatings voor de metaalverwerkende industrie. Primers en toplagen voor maximale oppervlaktebescherming onder alle weersomstandigheden — klaar voor automatische verflijnen en snelle elektrostatische applicatie.","Een tijdelijke schaduwcoating voor kassen die jonge gewassen beschermt tegen de felle zon. Optimale lichtregulatie op glas en polycarbonaat, gemaakt van circulair krijt — en volledig verwijderbaar.","Hoogwaardige hars-vloercoatingsystemen — epoxy, polyaspartic en urethaan. 100% solids, 0-VOC chemie voor garages, showrooms en veeleisende industriële vloeren.","Een industrieel inkleursysteem met hoogwaardige kleurpasta’s voor industriële, protective en vloercoatings. Consistente, reproduceerbare kleur voor solventgedragen systemen, ondersteund door de RedLike™-software."],"pl":["Powłoka antykorozyjna nakładana bezpośrednio na istniejącą rdzę — bez piaskowania. Zamyka korozję i chroni maszyny rolnicze, ciężarówki i konstrukcje na długie lata.","Kompletna linia renowacji samochodowej — lakiery bezbarwne, podkłady, uszczelniacze, fabrycznie pakowane kolory i ochrona antykorozyjna do napraw karoserii, ciężarówek i sprzętu.","Wysokiej jakości powłoki przemysłowe i farby budowlane. Cienkowarstwowa ochrona stali i infrastruktury, OEM i przemysłu metalowego, morskie i offshore — opracowane, by materiały służyły dłużej przy mniejszej ilości farby.","Kompletny biobazowy system malarski dla profesjonalnego malarza. Chemia roślinna z EU Ecolabel i certyfikatem Cradle to Cradle — najbardziej zielona farba, mieszalna w każdym kolorze.","Roślinna farba ścienna i lakierowa dla każdego. Kolekcje kolorów tworzone przez ekspertów, mieszane w każdym kolorze tęczy — online i na półce w Karwei.","Zintegrowany system renowacji dla transportu komercyjnego — odporne na korozję podkłady, uretanowe powłoki nawierzchniowe o wysokim połysku i program mieszania kolorów z precyzyjnym dopasowaniem barwy.","Twarde jak żelazo powłoki przemysłowe dla branży obróbki metali. Podkłady i powłoki nawierzchniowe zapewniające maksymalną ochronę powierzchni we wszystkich warunkach atmosferycznych — gotowe do automatycznych linii lakierniczych i szybkiej aplikacji elektrostatycznej.","Tymczasowa powłoka cieniująca do szklarni, która chroni młode uprawy przed ostrym słońcem. Optymalna regulacja światła na szkle i poliwęglanie, wykonana z obiegowej kredy — i całkowicie usuwalna.","Wysokowydajne systemy żywicznych powłok podłogowych — epoksyd, poliasparaginian i uretan. 100% części stałych, chemia 0-VOC do garaży, salonów i wymagających podłóg przemysłowych.","Przemysłowy system barwienia z wysokowydajnymi pastami kolorystycznymi do powłok przemysłowych, ochronnych i podłogowych. Spójny, powtarzalny kolor dla systemów rozpuszczalnikowych, wspierany oprogramowaniem RedLike™."],"ro":["O acoperire anticorozivă aplicată direct peste rugina existentă — fără sablare. Încapsulează coroziunea și protejează utilajele agricole, camioanele și structurile pe termen lung.","O linie completă de refinisare auto — lacuri transparente, grunduri, sigilanți, culori ambalate din fabrică și protecție anticorozivă pentru reparații de caroserie, camioane și echipamente.","Acoperiri industriale și vopsele pentru construcții de înaltă performanță. Protecție în strat subțire pentru oțel și infrastructură, OEM și industria metalică, maritim și offshore — concepute pentru a prelungi viața materialelor cu mai puțină vopsea.","Un sistem complet de vopsea biobazată pentru zugravul profesionist. Chimie vegetală cu EU Ecolabel și certificare Cradle to Cradle — cea mai verde vopsea, nuanțabilă în orice culoare.","Vopsea vegetală pentru pereți și lac pentru toți. Colecții de culori create de experți, nuanțate în orice culoare a curcubeului — online și pe raft la Karwei.","Un sistem integrat de refinisare pentru transportul comercial — grunduri rezistente la coroziune, straturi de finisare uretanice cu luciu ridicat și un program de culori intermix cu potrivire precisă a culorii.","Acoperiri industriale rezistente ca fierul pentru industria prelucrării metalelor. Grunduri și straturi de finisare pentru protecție maximă a suprafeței în toate condițiile atmosferice — pregătite pentru linii automate de vopsire și aplicare electrostatică rapidă.","O acoperire temporară de umbrire pentru sere care protejează culturile tinere de soarele puternic. Reglare optimă a luminii pe sticlă și policarbonat, fabricată din cretă circulară — și complet detașabilă.","Sisteme de acoperire a pardoselilor pe bază de rășină de înaltă performanță — epoxidic, poliaspartic și uretanic. 100% substanțe solide, chimie 0-VOC pentru garaje, showroom-uri și pardoseli industriale exigente.","Un sistem industrial de nuanțare cu paste de culoare de înaltă performanță pentru acoperiri industriale, de protecție și de pardoseală. Culoare consistentă și reproductibilă pentru sisteme pe bază de solvent, susținut de software-ul RedLike™."],"de":["Eine Rostschutzbeschichtung, die direkt über vorhandenen Rost aufgetragen wird — ohne Sandstrahlen. Sie kapselt die Korrosion ein und schützt Landmaschinen, Lkw und Konstruktionen langfristig.","Eine komplette Automotive-Refinish-Linie — Klarlacke, Grundierungen, Füller, werkseitig abgefüllte Farben und Rostschutz für Karosserie-, Lkw- und Geräteinstandsetzung.","Hochwertige Industriebeschichtungen und Bautenfarben. Dünnschicht-Schutz für Stahl und Infrastruktur, OEM und Metallindustrie, Marine & Offshore — entwickelt, um Materialien länger haltbar zu machen, mit weniger Farbe.","Ein komplettes biobasiertes Farbsystem für den Profimaler. Pflanzliche Chemie mit EU Ecolabel und Cradle-to-Cradle-Zertifizierung — die grünste Farbe, in jeder Farbe mischbar.","Pflanzliche Wand- und Lackfarbe für alle. Von Experten zusammengestellte Farbkollektionen, in jeder Farbe des Regenbogens mischbar — online und im Regal bei Karwei.","Ein integriertes Refinish-System für den gewerblichen Transport — korrosionsbeständige Grundierungen, hochglänzende Polyurethan-Decklacke und ein Intermix-Farbprogramm mit präziser Farbabstimmung.","Eisenstarke Industriebeschichtungen für die metallverarbeitende Industrie. Grundierungen und Decklacke für maximalen Oberflächenschutz unter allen Witterungsbedingungen — bereit für automatische Lackierlinien und schnelle elektrostatische Applikation.","Eine temporäre Schattierungsbeschichtung für Gewächshäuser, die junge Kulturen vor der grellen Sonne schützt. Optimale Lichtregulierung auf Glas und Polycarbonat, aus zirkulärer Kreide — und vollständig entfernbar.","Hochleistungs-Harzbodenbeschichtungssysteme — Epoxid, Polyaspartik und Polyurethan. 100% Festkörperanteil, 0-VOC-Chemie für Garagen, Showrooms und anspruchsvolle Industrieböden.","Ein industrielles Abtönsystem mit hochwertigen Farbpasten für Industrie-, Schutz- und Bodenbeschichtungen. Konsistente, reproduzierbare Farbe für lösemittelbasierte Systeme, unterstützt durch die RedLike™-Software."],"fr":["Un revêtement anticorrosion qui s'applique directement sur la rouille existante — sans sablage. Il encapsule la corrosion et protège durablement le matériel agricole, les camions et les structures.","Une gamme complète de refinish automobile — vernis, primaires, apprêts, couleurs conditionnées en usine et antirouille pour la réparation de carrosseries, de camions et d'équipements.","Des revêtements industriels et peintures du bâtiment haut de gamme. Une protection en couche mince pour l'acier et l'infrastructure, l'OEM et l'industrie métallique, le marine et l'offshore — conçue pour faire durer les matériaux plus longtemps avec moins de peinture.","Un système de peinture biosourcé complet pour le peintre professionnel. Une chimie végétale avec EU Ecolabel et certification Cradle to Cradle — la peinture la plus verte, teintable dans toutes les couleurs.","Une peinture murale et laque végétale pour tous. Des collections de couleurs composées par des experts, teintables dans toutes les couleurs de l'arc-en-ciel — en ligne et en rayon chez Karwei.","Un système de refinish intégré pour le transport commercial — des primaires résistants à la corrosion, des couches de finition uréthane très brillantes et un programme de couleurs intermix avec une mise à la teinte précise.","Des revêtements industriels solides comme le fer pour l'industrie de la transformation des métaux. Des primaires et des couches de finition pour une protection maximale de la surface dans toutes les conditions atmosphériques — prêts pour les lignes de peinture automatiques et l'application électrostatique rapide.","Un revêtement d'ombrage temporaire pour serres qui protège les jeunes cultures du soleil intense. Régulation optimale de la lumière sur verre et polycarbonate, à base de craie circulaire — et entièrement amovible.","Des systèmes de revêtement de sol résineux haute performance — époxy, polyaspartique et uréthane. 100% d'extrait sec, une chimie 0-COV pour garages, showrooms et sols industriels exigeants.","Un système de teinte industriel avec des pâtes colorantes haute performance pour revêtements industriels, de protection et de sol. Une couleur constante et reproductible pour les systèmes à base de solvant, soutenu par le logiciel RedLike™."],"es":["Un recubrimiento anticorrosión que se aplica directamente sobre el óxido existente — sin chorreado. Encapsula la corrosión y protege la maquinaria agrícola, los camiones y las estructuras a largo plazo.","Una línea completa de repintado del automóvil — barnices, imprimaciones, selladores, colores envasados de fábrica y protección antioxidante para la reparación de carrocerías, camiones y equipos.","Recubrimientos industriales y pinturas de construcción de alta calidad. Protección en capa fina para acero e infraestructura, OEM e industria del metal, marina y offshore — diseñada para alargar la vida de los materiales con menos pintura.","Un sistema de pintura biobasado completo para el pintor profesional. Química vegetal con EU Ecolabel y certificación Cradle to Cradle — la pintura más verde, tintable en cualquier color.","Pintura mural y laca vegetal para todos. Colecciones de color compuestas por expertos, tintables en todos los colores del arcoíris — online y en el lineal de Karwei.","Un sistema de repintado integrado para el transporte comercial — imprimaciones resistentes a la corrosión, capas de acabado de uretano de alto brillo y un programa de colores intermix con igualación de color precisa.","Recubrimientos industriales resistentes como el hierro para la industria de la transformación del metal. Imprimaciones y capas de acabado para una protección máxima de la superficie en todas las condiciones atmosféricas — listos para líneas de pintura automáticas y aplicación electrostática rápida.","Un recubrimiento de sombreo temporal para invernaderos que protege los cultivos jóvenes del sol intenso. Regulación óptima de la luz sobre vidrio y policarbonato, hecho de tiza circular — y totalmente eliminable.","Sistemas de recubrimiento de suelos resinosos de alto rendimiento — epoxi, poliaspártico y uretano. 100% de sólidos, química 0-COV para garajes, salas de exposición y exigentes suelos industriales.","Un sistema de tintado industrial con pastas de color de alto rendimiento para recubrimientos industriales, de protección y de suelo. Color constante y reproducible para sistemas con base disolvente, respaldado por el software RedLike™."],"it":["Un rivestimento anticorrosione che si applica direttamente sulla ruggine esistente — senza sabbiatura. Incapsula la corrosione e protegge a lungo termine macchine agricole, camion e strutture.","Una linea completa di refinish automobilistico — vernici trasparenti, primer, sigillanti, colori confezionati in fabbrica e protezione antiruggine per riparazioni di carrozzeria, camion e attrezzature.","Rivestimenti industriali e pitture per l'edilizia di alta qualità. Protezione a strato sottile per acciaio e infrastrutture, OEM e industria del metallo, marina e offshore — progettata per far durare di più i materiali con meno vernice.","Un sistema di pittura biobased completo per l'imbianchino professionista. Chimica vegetale con EU Ecolabel e certificazione Cradle to Cradle — la vernice più verde, colorabile in ogni colore.","Pittura murale e smalto vegetali per tutti. Collezioni di colori curate da esperti, miscelabili in ogni colore dell'arcobaleno — online e a scaffale da Karwei.","Un sistema di refinish integrato per il trasporto commerciale — primer resistenti alla corrosione, strati di finitura uretanici ad alta brillantezza e un programma colori intermix con abbinamento cromatico preciso.","Rivestimenti industriali resistenti come il ferro per l'industria della lavorazione dei metalli. Primer e strati di finitura per la massima protezione della superficie in tutte le condizioni atmosferiche — pronti per linee di verniciatura automatiche e applicazione elettrostatica rapida.","Un rivestimento ombreggiante temporaneo per serre che protegge le giovani colture dal sole intenso. Regolazione ottimale della luce su vetro e policarbonato, in gesso circolare — e completamente rimovibile.","Sistemi di rivestimento per pavimenti resinosi ad alte prestazioni — epossidico, poliaspartico e uretano. 100% solidi, chimica 0-VOC per garage, showroom e pavimenti industriali esigenti.","Un sistema di tintometria industriale con paste coloranti ad alte prestazioni per rivestimenti industriali, protettivi e per pavimenti. Colore costante e riproducibile per sistemi a base solvente, supportato dal software RedLike™."],"tr":["Mevcut pasın doğrudan üzerine uygulanan, kumlamasız bir pas önleyici kaplama. Korozyonu hapseder ve tarım makinelerini, kamyonları ve yapıları uzun süre korur.","Eksiksiz bir otomotiv refinish serisi — vernikler, astarlar, dolgu astarları, fabrika ambalajlı renkler ve kaporta, kamyon ve ekipman onarımı için pas önleme.","Yüksek kaliteli endüstriyel kaplamalar ve yapı boyaları. Çelik ve altyapı, OEM ve metal sanayisi, denizcilik ve offshore için ince katman koruması — malzemeleri daha az boyayla daha uzun süre dayanıklı kılmak için geliştirildi.","Profesyonel boyacı için eksiksiz bir biyobazlı boya sistemi. EU Ecolabel ve Cradle to Cradle sertifikalı bitkisel kimya — en yeşil boya, her renge boyanabilir.","Herkes için bitkisel duvar ve lake boya. Uzmanlarca derlenen renk koleksiyonları, gökkuşağının her renginde karıştırılabilir — çevrimiçi ve Karwei raflarında.","Ticari taşımacılık için entegre bir refinish sistemi — korozyona dayanıklı astarlar, yüksek parlaklıkta üretan son katlar ve hassas renk eşleştirmeli bir intermix renk programı.","Metal işleme endüstrisi için demir kadar güçlü endüstriyel kaplamalar. Tüm atmosferik koşullarda maksimum yüzey koruması sağlayan astarlar ve son katlar — otomatik boya hatları ve hızlı elektrostatik uygulama için hazır.","Genç bitkileri sert güneşten koruyan, seralar için geçici bir gölgeleme kaplaması. Cam ve polikarbonatta en uygun ışık düzenlemesi, döngüsel tebeşirden üretilir — ve tamamen çıkarılabilir.","Yüksek performanslı reçine esaslı zemin kaplama sistemleri — epoksi, poliaspartik ve üretan. Garajlar, showroom'lar ve zorlu endüstriyel zeminler için %100 katı madde, 0-VOC kimyası.","Endüstriyel, koruyucu ve zemin kaplamaları için yüksek performanslı renk pastaları sunan endüstriyel bir renklendirme sistemi. Solvent bazlı sistemler için tutarlı, tekrarlanabilir renk, RedLike™ yazılımıyla desteklenir."]}],
    ['.spec b', { nl: ['Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment', 'Assortiment'], pl: ['Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment', 'Asortyment'], ro: ['Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă', 'Gamă'], de: ['Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment', 'Sortiment'], fr: ['Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme', 'Gamme'], es: ['Gama', 'Gama', 'Gama', 'Gama', 'Gama', 'Gama', 'Gama', 'Gama', 'Gama', 'Gama'], it: ['Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma', 'Gamma'], tr: ['Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı', 'Ürün gamı'] }],
