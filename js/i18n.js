...
(() => {
  ...
  const MAP = [
    ...
    ['.story-col p', {
      ...
      es: [
        'La familia Duijghuisen se atreve a tomar decisiones distintas — y donde es financieramente responsable, optamos por lo sostenible: fábricas más limpias, lugares de trabajo seguros, una flota eléctrica e híbrida. Nuestro mayor capital es un equipo comprometido y motivado — accesible, honesto e implicado.',
      ...
      it: [
        'La famiglia Duijghuisen osa fare scelte diverse — e dove è finanziariamente responsabile, scegliamo la sostenibilità: fabbriche più pulite, luoghi di lavoro sicuri, una flotta elettrica e ibrida. Il nostro capitale più grande è un team dedito e motivato — accessibile, onesto e partecipe.',
    ...
    ['.timeline li span', {
      nl: [
        ...
        'Oprichting Baril Coatings Polska', 'Baril USA opgericht samen met de familie Harmon — vandaag geleid door Dave Harmon en zijn kinderen · start CO₂-footprintmonitoring',
        'Nederlands patent voor DCC- (DualCure-)technologie', 'Biobased grondstoffen als kernwaarde aangenomen',
        'Introductie biobased schilderverven · overname door Baril Group', 'DCC gepatenteerd in de EU, VS en Canada · Best Managed Company',
      ...
      pl: [
        ...
        'Założenie Baril Coatings Polska', 'Baril USA założona wspólnie z rodziną Harmon — dziś prowadzona przez Dave\'a Harmona i jego dzieci · start monitoringu śladu CO₂',
        'Holenderski patent na technologię DCC (DualCure)', 'Surowce biobazowe przyjęte jako wartość podstawowa',
        'Wprowadzenie biobazowych farb malarskich · przejęcie przez Baril Group', 'DCC opatentowane w UE, USA i Kanadzie · Best Managed Company',
      ...
      ro: [
        ...
        'Înființarea Baril Coatings Polska', 'Baril USA înființată împreună cu familia Harmon — astăzi condusă de Dave Harmon și copiii săi · începe monitorizarea amprentei CO₂',
        'Brevet olandez pentru tehnologia DCC (DualCure)', 'Materiile prime biobazate adoptate ca valoare centrală',
        'Lansarea vopselelor biobazate · preluare de către Baril Group', 'DCC brevetată în UE, SUA și Canada · Best Managed Company',
      ...
      de: [
        ...
        'Gründung von Baril Coatings Polska', 'Baril USA gegründet gemeinsam mit der Familie Harmon — heute geführt von Dave Harmon und seinen Kindern · Start des CO₂-Fußabdruck-Monitorings',
        'Niederländisches Patent für die DCC- (DualCure-)Technologie', 'Biobasierte Rohstoffe als Kernwert verankert',
        'Einführung biobasierter Anstrichfarben · Übernahme durch Baril Group', 'DCC patentiert in der EU, USA und Kanada · Best Managed Company',
      ...
      fr: [
        ...
        'Création de Baril Coatings Polska', 'Baril USA fondée avec la famille Harmon — aujourd\'hui dirigée par Dave Harmon et ses enfants · début du suivi de l\'empreinte CO₂',
        'Brevet néerlandais pour la technologie DCC (DualCure)', 'Matières premières biosourcées adoptées comme valeur centrale',
        'Lancement des peintures biosourcées · reprise par Baril Group', 'DCC brevetée dans l\'UE, aux USA et au Canada · Best Managed Company',
      ...
      es: [
        'Fundada el 12 de noviembre en Moerkapelle', "Traslado a una nueva planta en 's-Hertogenbosch", 'Compra por la dirección (MBO)',
        'Fundación de Baril Coatings Polska', 'Baril USA fundada junto con la familia Harmon — hoy dirigida por Dave Harmon y sus hijos · comienza el seguimiento de la huella de CO₂',
        'Patente neerlandesa de la tecnología DCC (DualCure)', 'Materias primas biobasadas adoptadas como valor central',
        'Lanzamiento de pinturas biobasadas · adquisición por Baril Group', 'DCC patentada en la UE, EE. UU. y Canadá · Best Managed Company',
        "Cubiertas solares en Etten-Leur y 's-Hertogenbosch", 'Lanzamiento de Baril Academy', 'Flota totalmente eléctrica · marcas de consumo vegetales gestionadas en propio',
        'Inicio de la transición al 100% de materias primas renovables', '802 BIO y 803 BIO — los primeros recubrimientos epoxi biobasados de calidad industrial',
        'Ganador del Brabant Innovation Award', 'Certificada B Corp — uno de los primeros fabricantes de recubrimientos de protección del mundo · KVK Circular Innovation Award (Química)'],
      it: [
        'Fondata il 12 novembre a Moerkapelle', "Trasferimento in un nuovo stabilimento a 's-Hertogenbosch", 'Management buy-out',
        'Fondazione di Baril Coatings Polska', 'Baril USA fondata insieme alla famiglia Harmon — oggi guidata da Dave Harmon e dai suoi figli · inizia il monitoraggio dell\'impronta di CO₂',
        'Brevetto olandese per la tecnologia DCC (DualCure)', 'Materie prime biobased adottate come valore centrale',
        'Lancio delle pitture biobased · acquisizione da parte di Baril Group', 'DCC brevettata in UE, USA e Canada · Best Managed Company',
        "Tetti solari a Etten-Leur e 's-Hertogenbosch", 'Lancio della Baril Academy', 'Flotta completamente elettrica · marchi di consumo vegetali gestiti internamente',
        'Inizio della transizione verso il 100% di materie prime rinnovabili', '802 BIO e 803 BIO — i primi rivestimenti epossidici biobased di qualità industriale',
        'Vincitore del Brabant Innovation Award', 'Certificata B Corp — tra i primi produttori di rivestimenti protettivi al mondo · KVK Circular Innovation Award (Chimica)'] }],
