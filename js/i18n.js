...
(() => {
  ...
  const MAP = [
    ...
    ['.brand .tag', { nl: ['Voor de industrie', 'Voor de vakschilder', 'Voor thuis', 'Voor de tuinbouw', 'Voor kleur', 'Voor metaal', 'Voor de landbouw', 'Voor vloeren', 'Voor wagenparken', 'Voor refinish'], pl: ['Dla przemysłu', 'Dla profesjonalnego malarza', 'Do domu', 'Dla ogrodnictwa', 'Dla koloru', 'Do metalu', 'Dla rolnictwa', 'Do podłóg', 'Dla flot', 'Do renowacji'], ro: ['Pentru industrie', 'Pentru zugravul profesionist', 'Pentru casă', 'Pentru horticultură', 'Pentru culoare', 'Pentru metal', 'Pentru agricultură', 'Pentru pardoseli', 'Pentru flote', 'Pentru refinisare'], de: ['Für die Industrie', 'Für den Profimaler', 'Für zu Hause', 'Für den Gartenbau', 'Für Farbe', 'Für Metall', 'Für die Landwirtschaft', 'Für Böden', 'Für Fuhrparks', 'Für Refinish'], fr: ['Pour l\'industrie', 'Pour le peintre pro', 'Pour la maison', 'Pour l\'horticulture', 'Pour la couleur', 'Pour le métal', 'Pour l\'agriculture', 'Pour les sols', 'Pour les flottes', 'Pour le refinish'], es: ['Para la industria', 'Para el pintor pro', 'Para el hogar', 'Para la horticultura', 'Para el color', 'Para el metal', 'Para la agricultura', 'Para suelos', 'Para flotas', 'Para el repintado'], it: ['Per l\'industria', 'Per l\'imbianchino pro', 'Per la casa', 'Per l\'orticoltura', 'Per il colore', 'Per il metallo', 'Per l\'agricoltura', 'Per i pavimenti', 'Per le flotte', 'Per il refinish'], tr: ['Sanayi için', 'Profesyonel boyacı için', 'Ev için', 'Bahçecilik için', 'Renk için', 'Metal için', 'Tarım için', 'Zeminler için', 'Filolar için', 'Refinish için'] }],
    ['.brand > div:first-child > p:not(.tag)', {
      nl: [
        ...
        'IJzersterke industriële coatings voor de metaalverwerkende industrie. Primers en toplagen voor maximale oppervlaktebescherming onder alle weersomstandigheden — klaar voor automatische verflijnen en snelle elektrostatische applicatie.',
        'Een roestwerende coating die direct over bestaande roest gaat — zonder stralen. Hij kapselt corrosie in en beschermt landbouwmachines, vrachtwagens en constructies voor de lange termijn.',
        'Hoogwaardige hars-vloercoatingsystemen — epoxy, polyaspartic en urethaan. 100% solids, 0-VOC chemie voor garages, showrooms en veeleisende industriële vloeren.',
        'Een geïntegreerd refinish-systeem voor het commerciële transport — corrosiebestendige primers, hoogglanzende urethaan toplagen en een intermix-kleurenprogramma met nauwkeurige kleuraanpassing.',
        'Een complete automotive refinish-lijn — blanke lakken, primers, sealers, fabrieksmatig verpakte kleuren en roestwering voor reparaties aan autobody, vrachtwagens en materieel.'],
      pl: [
        ...
        'Twarde jak żelazo powłoki przemysłowe dla branży obróbki metali. Podkłady i powłoki nawierzchniowe zapewniające maksymalną ochronę powierzchni we wszystkich warunkach atmosferycznych — gotowe do automatycznych linii lakierniczych i szybkiej aplikacji elektrostatycznej.',
        'Powłoka antykorozyjna nakładana bezpośrednio na istniejącą rdzę — bez piaskowania. Zamyka korozję i chroni maszyny rolnicze, ciężarówki i konstrukcje na długie lata.',
        'Wysokowydajne systemy żywicznych powłok podłogowych — epoksyd, poliasparaginian i uretan. 100% części stałych, chemia 0-VOC do garaży, salonów i wymagających podłóg przemysłowych.',
        'Zintegrowany system renowacji dla transportu komercyjnego — odporne na korozję podkłady, uretanowe powłoki nawierzchniowe o wysokim połysku i program mieszania kolorów z precyzyjnym dopasowaniem barwy.',
        'Kompletna linia renowacji samochodowej — lakiery bezbarwne, podkłady, uszczelniacze, fabrycznie pakowane kolory i ochrona antykorozyjna do napraw karoserii, ciężarówek i sprzętu.'],
      ro: [
        ...
        'Acoperiri industriale rezistente ca fierul pentru industria prelucrării metalelor. Grunduri și straturi de finisare pentru protecție maximă a suprafeței în toate condițiile atmosferice — pregătite pentru linii automate de vopsire și aplicare electrostatică rapidă.',
        'O acoperire anticorozivă aplicată direct peste rugina existentă — fără sablare. Încapsulează coroziunea și protejează utilajele agricole, camioanele și structurile pe termen lung.',
        'Sisteme de acoperire a pardoselilor pe bază de rășină de înaltă performanță — epoxidic, poliaspartic și uretanic. 100% substanțe solide, chimie 0-VOC pentru garaje, showroom-uri și pardoseli industriale exigente.',
        'Un sistem integrat de refinisare pentru transportul comercial — grunduri rezistente la coroziune, straturi de finisare uretanice cu luciu ridicat și un program de culori intermix cu potrivire precisă a culorii.',
        'O linie completă de refinisare auto — lacuri transparente, grunduri, sigilanți, culori ambalate din fabrică și protecție anticorozivă pentru reparații de caroserie, camioane și echipamente.'],
      de: [
        ...
        'Eisenstarke Industriebeschichtungen für die metallverarbeitende Industrie. Grundierungen und Decklacke für maximalen Oberflächenschutz unter allen Witterungsbedingungen — bereit für automatische Lackierlinien und schnelle elektrostatische Applikation.',
        'Eine Rostschutzbeschichtung, die direkt über vorhandenen Rost aufgetragen wird — ohne Sandstrahlen. Sie kapselt die Korrosion ein und schützt Landmaschinen, Lkw und Konstruktionen langfristig.',
        'Hochleistungs-Harzbodenbeschichtungssysteme — Epoxid, Polyaspartik und Polyurethan. 100% Festkörperanteil, 0-VOC-Chemie für Garagen, Showrooms und anspruchsvolle Industrieböden.',
        'Ein integriertes Refinish-System für den gewerblichen Transport — korrosionsbeständige Grundierungen, hochglänzende Polyurethan-Decklacke und ein Intermix-Farbprogramm mit präziser Farbabstimmung.',
        'Eine komplette Automotive-Refinish-Linie — Klarlacke, Grundierungen, Füller, werkseitig abgefüllte Farben und Rostschutz für Karosserie-, Lkw- und Geräteinstandsetzung.'],
      fr: [
        ...
        'Des revêtements industriels solides comme le fer pour l\'industrie de la transformation des métaux. Des primaires et des couches de finition pour une protection maximale de la surface dans toutes les conditions atmosphériques — prêts pour les lignes de peinture automatiques et l\'application électrostatique rapide.',
        'Un revêtement anticorrosion qui s\'applique directement sur la rouille existante — sans sablage. Il encapsule la corrosion et protège durablement le matériel agricole, les camions et les structures.',
        'Des systèmes de revêtement de sol résineux haute performance — époxy, polyaspartique et uréthane. 100% d\'extrait sec, une chimie 0-COV pour garages, showrooms et sols industriels exigeants.',
        'Un système de refinish intégré pour le transport commercial — des primaires résistants à la corrosion, des couches de finition uréthane très brillantes et un programme de couleurs intermix avec une mise à la teinte précise.',
        'Une gamme complète de refinish automobile — vernis, primaires, apprêts, couleurs conditionnées en usine et antirouille pour la réparation de carrosseries, de camions et d\'équipements.'],
      es: [
        ...
        'Recubrimientos industriales resistentes como el hierro para la industria de la transformación del metal. Imprimaciones y capas de acabado para una protección máxima de la superficie en todas las condiciones atmosféricas — listos para líneas de pintura automáticas y aplicación electrostática rápida.',
        'Un recubrimiento anticorrosión que se aplica directamente sobre el óxido existente — sin chorreado. Encapsula la corrosión y protege la maquinaria agrícola, los camiones y las estructuras a largo plazo.',
        'Sistemas de recubrimiento de suelos resinosos de alto rendimiento — epoxi, poliaspártico y uretano. 100% de sólidos, química 0-COV para garajes, salas de exposición y exigentes suelos industriales.',
        'Un sistema de repintado integrado para el transporte comercial — imprimaciones resistentes a la corrosión, capas de acabado de uretano de alto brillo y un programa de colores intermix con igualación de color precisa.',
        'Una línea completa de repintado del automóvil — barnices, imprimaciones, selladores, colores envasados de fábrica y protección antioxidante para la reparación de carrocerías, camiones y equipos.'],
      it: [
        ...
        'Rivestimenti industriali resistenti come il ferro per l\'industria della lavorazione dei metalli. Primer e strati di finitura per la massima protezione della superficie in tutte le condizioni atmosferiche — pronti per linee di verniciatura automatiche e applicazione elettrostatica rapida.',
        'Un rivestimento anticorrosione che si applica direttamente sulla ruggine esistente — senza sabbiatura. Incapsula la corrosione e protegge a lungo termine macchine agricole, camion e strutture.',
        'Sistemi di rivestimento per pavimenti resinosi ad alte prestazioni — epossidico, poliaspartico e uretano. 100% solidi, chimica 0-VOC per garage, showroom e pavimenti industriali esigenti.',
        'Un sistema di refinish integrato per il trasporto commerciale — primer resistenti alla corrosione, strati di finitura uretanici ad alta brillantezza e un programma colori intermix con abbinamento cromatico preciso.',
        'Una linea completa di refinish automobilistico — vernici trasparenti, primer, sigillanti, colori confezionati in fabbrica e protezione antiruggine per riparazioni di carrozzeria, camion e attrezzature.'],
      tr: [
        ...
        'Metal işleme endüstrisi için demir kadar güçlü endüstriyel kaplamalar. Tüm atmosferik koşullarda maksimum yüzey koruması sağlayan astarlar ve son katlar — otomatik boya hatları ve hızlı elektrostatik uygulama için hazır.',
        'Mevcut pasın doğrudan üzerine uygulanan, kumlamasız bir pas önleyici kaplama. Korozyonu hapseder ve tarım makinelerini, kamyonları ve yapıları uzun süre korur.',
        'Yüksek performanslı reçine esaslı zemin kaplama sistemleri — epoksi, poliaspartik ve üretan. Garajlar, showroom\'lar ve zorlu endüstriyel zeminler için %100 katı madde, 0-VOC kimyası.',
        'Ticari taşımacılık için entegre bir refinish sistemi — korozyona dayanıklı astarlar, yüksek parlaklıkta üretan son katlar ve hassas renk eşleştirmeli bir intermix renk programı.',
        'Eksiksiz bir otomotiv refinish serisi — vernikler, astarlar, dolgu astarları, fabrika ambalajlı renkler ve kaporta, kamyon ve ekipman onarımı için pas önleme.'] }],
