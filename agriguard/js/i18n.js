...
(() => {
  ...
  const MAP = [
    ...
    ['#performance .lead', {
      nl: 'AgriGuard stopt roest waar hij zit — kapselt corrosie in en sluit oppervlakken af tegen vocht, zuurstof en de elementen. Gemaakt in Angola, Indiana, voor korte, betrouwbare levering.',
      pl: 'AgriGuard zatrzymuje rdzę tam, gdzie się znajduje — kapsułkuje korozję i odcina powierzchnie od wilgoci, tlenu i żywiołów. Produkowane w Angola, Indiana, dla krótkich i niezawodnych dostaw.',
      ro: 'AgriGuard oprește rugina acolo unde se află — încapsulează coroziunea și izolează suprafețele de umiditate, oxigen și intemperii. Fabricat în Angola, Indiana, pentru o aprovizionare scurtă și fiabilă.',
      de: 'AgriGuard stoppt Rost dort, wo er ist — kapselt Korrosion ein und schließt Oberflächen gegen Feuchtigkeit, Sauerstoff und Witterung ab. Hergestellt in Angola, Indiana, für kurze, verlässliche Lieferung.',
      fr: 'AgriGuard stoppe la rouille là où elle se trouve — encapsule la corrosion et isole les surfaces de l\'humidité, de l\'oxygène et des intempéries. Fabriqué à Angola, Indiana, pour un approvisionnement court et fiable.',
      es: 'AgriGuard detiene el óxido donde está — encapsula la corrosión y aísla las superficies de la humedad, el oxígeno y las inclemencias. Fabricado en Angola, Indiana, para un suministro corto y fiable.',
      it: 'AgriGuard ferma la ruggine dove si trova — incapsula la corrosione e isola le superfici da umidità, ossigeno e intemperie. Prodotto ad Angola, Indiana, per una fornitura breve e affidabile.',
      tr: 'AgriGuard pası olduğu yerde durdurur — korozyonu kapsüller ve yüzeyleri neme, oksijene ve hava koşullarına karşı yalıtır. Angola, Indiana\'da üretilir, kısa ve güvenilir tedarik için.', no: 'AgriGuard stopper rust der den sitter — kapsler inn korrosjon og forsegler overflater mot fukt, oksygen og vær og vind. Laget i Angola, Indiana, for kort og pålitelig levering.', sv: 'AgriGuard stoppar rost där den sitter — kapslar in korrosion och förseglar ytor mot fukt, syre och väder och vind. Tillverkad i Angola, Indiana, för kort och pålitlig leverans.' }],
